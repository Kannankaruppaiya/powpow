import { C as sleep, F as shouldLogVerbose, M as logVerbose, T as toWhatsappJid, V as getChildLogger, f as isSelfChatMode, m as normalizeE164, p as jidToE164, r as clamp, v as resolveJidToE164 } from "./utils-C9Yd70Dr.js";
import { At as computeBackoff, Cr as enqueueSystemEvent, Dn as resolveInboundDebounceMs, En as createInboundDebouncer, Mn as shouldComputeCommandAuthorized, On as formatInboundEnvelope, Sr as normalizeMentionText, Tn as createDedupeCache, _n as resolveOpenProviderRuntimeGroupPolicy, bn as dispatchReplyWithBufferedBlockDispatcher, bt as parseActivationCommand, dn as buildPairingReply, fn as resolveMentionGating, gn as resolveDefaultGroupPolicy, hn as recordPendingHistoryEntryIfEnabled, jn as hasControlCommand, jt as sleepWithAbort, kn as resolveEnvelopeFormatOptions, mn as buildHistoryContextFromEntries, pn as DEFAULT_GROUP_HISTORY_LIMIT, t as getReplyFromConfig, vn as warnMissingProviderGroupPolicyFallbackOnce, xr as buildMentionRegexes, yn as shouldAckReactionForWhatsApp, yt as normalizeGroupActivation } from "./reply-DXKoJPvW.js";
import { f as defaultRuntime, t as createSubsystemLogger } from "./subsystem-A8uKC1In.js";
import { a as buildGroupHistoryKey, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey, s as normalizeAgentId } from "./session-key-C2FENQ1Z.js";
import { t as formatCliCommand } from "./command-format-DpXmP5EG.js";
import { i as loadConfig } from "./config-ClR1jZcN.js";
import { a as resolveChannelGroupRequireMention, i as resolveChannelGroupPolicy } from "./dock-Dwi_4IIN.js";
import { t as finalizeInboundContext } from "./inbound-context-ePeCwwOJ.js";
import { d as registerUnhandledRejectionHandler } from "./runner-D5ewLVko.js";
import { r as saveMediaBuffer } from "./store-CLQaQ0tz.js";
import { at as resolveGroupSessionKey, c as loadSessionStore, d as recordSessionMetaFromInbound, m as updateLastRoute, u as readSessionUpdatedAt } from "./sessions-fBW7dZrm.js";
import { i as resolveWhatsAppAccount, p as readWebSelfId, s as getWebAuthAgeMs } from "./accounts-CWi8B8Jm.js";
import { l as resolveStorePath } from "./paths-Da74Udq3.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-DMThNrwL.js";
import { i as readChannelAllowFromStore, s as upsertChannelPairingRequest } from "./pairing-store-BSzGxPBw.js";
import { r as formatDurationPrecise } from "./format-duration-XLSvPvzN.js";
import { J as formatLocationText, Y as toLocationContext } from "./send-qkxnhFdm.js";
import { c as resolveIdentityNamePrefix, l as resolveMessagePrefix, t as createReplyPrefixOptions } from "./reply-prefix-4xFugQQN.js";
import { c as resolveChunkMode, i as chunkMarkdownTextWithMode, l as resolveTextChunkLimit } from "./chunk-DEySYRr3.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-iuOnj7Cl.js";
import { a as loadWebMedia } from "./ir-BIBAnr1T.js";
import { n as recordChannelActivity } from "./channel-activity-DFMOrq2l.js";
import { t as convertMarkdownTables } from "./tables-zzWSbOhs.js";
import { n as resolveAgentRoute, t as buildAgentSessionKey } from "./resolve-route-DeMT-IKg.js";
import { r as setActiveWebListener } from "./active-listener-DQfODugI.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp } from "./outbound-B6cQE3XD.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session--yuCnBgV.js";
