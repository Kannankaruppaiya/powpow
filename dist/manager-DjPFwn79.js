...
import { i as resolveAgentDir, r as resolveAgentConfig, s as resolveAgentWorkspaceDir } from "./agent-scope-DxSdR-i1.js";
import { s as resolveStateDir } from "./paths-B4N4CZDb.js";
import { D as clampInt, K as truncateUtf16Safe, O as clampNumber, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-J2JHz_PH.js";
import { E as resolveApiKeyForProvider, T as requireApiKey } from "./model-selection-BIieOTxJ.js";
import { t as isTruthyEnvValue } from "./env-srzc75vD.js";
import { n as formatErrorMessage } from "./errors-D9rAZNPr.js";
import { c as resolveSessionTranscriptsDirForAgent } from "./paths-po6dFg-E.js";
import { n as onSessionTranscriptUpdate } from "./transcript-events-C2UPLtfk.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-qMuTTztU.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-B94HiDyW.js";
import { a as sessionPathForFile, c as cosineSimilarity, d as isMemoryPath, f as listMemoryFiles, g as runWithConcurrency, h as remapChunkLines, i as listSessionFilesForAgent, l as ensureDir, m as parseEmbedding, n as requireNodeSqlite, o as buildFileEntry, p as normalizeExtraMemoryPaths, r as buildSessionEntry, s as chunkMarkdown, t as extractKeywords, u as hashText, v as isFileMissingError, y as statRegularFile } from "./query-expansion-CVK_4K_2.js";
import { n as retryAsync } from "./retry-DTD5q341.js";
...
const debugEmbeddings = isTruthyEnvValue(process.env.POWPOW_DEBUG_MEMORY_EMBEDDINGS);
...
function formatLocalSetupError(err) {
	...
	return [
		...
		missing ? "2) Reinstall PowPow (this should install node-llama-cpp): npm i -g PowPow@latest" : null,
...
function buildGeminiUploadBody(params) {
	const boundary = `powpow-${hashText(params.displayName)}`;
...
var MemoryManagerSyncOps = class {
	...
	async runSync(params) {
		...
		try {
			if (needsFullReindex) {
				if (process.env.POWPOW_TEST_FAST === "1" && process.env.POWPOW_TEST_MEMORY_UNSAFE_REINDEX === "1") await this.runUnsafeReindex({
