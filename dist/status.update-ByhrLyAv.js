...
import { n as checkUpdateStatus, r as compareSemverStrings } from "./channel-account-context-23ILPOVs.js";
...
function formatUpdateAvailableHint(update) {
	...
	return `Update available${details.length > 0 ? ` (${details.join(" · ")})` : ""}. Run: ${formatCliCommand("PowPow update")}`;
}
