...
import { B as theme, P as setVerbose, S as shortenHomePath, y as resolveUserPath } from "./utils-C9Yd70Dr.js";
import "./thinking-EAliFiVK.js";
import { Gt as createDefaultDeps, Nt as agentCommand, Pt as resolveSessionKeyForRequest, an as parseIdentityMarkdown, rn as identityHasValues } from "./reply-DXKoJPvW.js";
import { a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, d as resolveDefaultAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir } from "./agent-scope-Coqt3COl.js";
import { f as defaultRuntime } from "./subsystem-A8uKC1In.js";
import { m as DEFAULT_ACCOUNT_ID, s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-C2FENQ1Z.js";
import "./exec-7lv95ExR.js";
import { Lt as resolveAuthStorePath, Pt as ensureAuthProfileStore } from "./model-selection-DAT49TVG.js";
...
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-Bc5gLV-e.js";
import "./send-BYGkmhGE.js";
import { i as loadConfig, l as writeConfigFile } from "./config-ClR1jZcN.js";
...
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-rCyIPzMG.js";
...
import { c as resolveSessionTranscriptsDirForAgent } from "./paths-Da74Udq3.js";
...
import { a as randomIdempotencyKey, n as callGateway } from "./call-VpiD4sCY.js";
...
import { a as ensureWorkspaceAndSessions, l as moveToTrash } from "./onboard-helpers-D8_1U5gk.js";
...
import { t as collectOption } from "./helpers-DGBa5iKd.js";
...
import { a as parseBindingSpecs, i as describeBinding, n as applyAgentBindings, o as removeAgentBindings, r as buildChannelBindings, t as requireValidConfigSnapshot } from "./config-validation-53cX85mR.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, n as buildAgentSummaries, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BpzZAuEp.js";
...
import { r as setupChannels } from "./onboard-channels-5WdxhpY2.js";
...
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-CnYSMKZk.js";
import { i as applyAuthChoice, r as warnIfModelConfigLooksOff } from "./auth-choice-CnthXhjN.js";
...
async function agentViaGatewayCommand(opts, runtime) {
	...
	if (agentId) {
		if (!listAgentIds(cfg).includes(agentId)) throw new Error(`Unknown agent id "${agentIdRaw}". Use "${formatCliCommand("PowPow agents list")}" to see configured agents.`);
	}
...
async function agentsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	try {
		await prompter.intro("Add PowPow agent");
		...
		} else await prompter.note(["Routing unchanged. Add bindings when you're ready.", "Docs: https://docs.PowPow.ai/concepts/multi-agent"].join("\n"), "Routing");
...
async function agentsListCommand(opts, runtime = defaultRuntime) {
	...
	lines.push(`Channel status reflects local config/creds. For live health: ${formatCliCommand("PowPow channels status --probe")}.`);
...
${formatHelpExamples([
		["PowPow agent --to +15555550123 --message \"status update\"", "Start a new session."],
		["PowPow agent --agent ops --message \"Summarize logs\"", "Use a specific agent."],
		["PowPow agent --session-id 1234 --message \"Summarize inbox\" --thinking medium", "Target a session with explicit thinking level."],
		["PowPow agent --to +15555550123 --message \"Trace logs\" --verbose on --json", "Enable verbose logging and JSON output."],
		["PowPow agent --to +15555550123 --message \"Summon reply\" --deliver", "Deliver reply."],
		["PowPow agent --agent ops --message \"Generate report\" --deliver --reply-channel slack --reply-to \"#reports\"", "Send reply to a different channel/target."]
	])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.PowPow.ai/cli/agent")}`).action(async (opts) => {
...
${theme.heading("Examples:")}
${formatHelpExamples([
		["PowPow agents set-identity --agent main --name \"PowPow\" --emoji \"🦞\"", "Set name + emoji."],
		["PowPow agents set-identity --agent main --avatar avatars/PowPow.png", "Set avatar path."],
		["PowPow agents set-identity --workspace ~/.PowPow/workspace --from-identity", "Load from IDENTITY.md."],
		["PowPow agents set-identity --identity-file ~/.PowPow/workspace/IDENTITY.md --agent main", "Use a specific IDENTITY.md."]
	])}
`).action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
