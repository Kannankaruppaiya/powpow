import { c as resolveDefaultAgentId, h as resolveAgentModelPrimaryValue, s as resolveAgentWorkspaceDir } from "./agent-scope-rrgzCI7i.js";
import { c as expandHomePrefix, n as resolveConfigPath, r as resolveDefaultConfigCandidates, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-T4GVdxf1.js";
import { L as resolveConfigDir, M as isRecord, p as normalizeChatChannelId, q as isPlainObject$2, s as CHANNEL_IDS, z as resolveUserPath } from "./subsystem-COVUh7Yl.js";
import { h as isBlockedObjectKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-YGVrIVO5.js";
import { A as loadShellEnvFallback, F as isDangerousHostEnvVarName, I as normalizeEnvVarKey, M as shouldDeferShellEnvFallback, N as shouldEnableShellEnvFallback, P as isDangerousHostEnvOverrideVarName, c as normalizeProviderId, j as resolveShellEnvFallbackTimeoutMs, l as parseModelRef, nt as DEFAULT_CONTEXT_TOKENS } from "./model-selection-CtYSbl7o.js";
import { c as resolveMemorySlotDecision, l as isPathInside, o as normalizePluginsConfig, s as resolveEffectiveEnableState, t as loadPluginManifestRegistry } from "./manifest-registry-C-rdkpms.js";
...
//#endregion
export { SAFE_BIN_PROFILES as $, getConfigValueAtPath as A, buildEnforcedShellCommand as B, isPathWithinRoot as C, resetConfigOverrides as D, getConfigOverrides as E, isTrustedSafeBinPath as F, resolveAllowlistCandidatePath as G, splitCommandChain as H, listWritableExplicitTrustedSafeBinDirs as I, isDispatchWrapperExecutable as J, resolveCommandResolutionFromArgv as K, normalizeTrustedSafeBinDirs as L, setConfigValueAtPath as M, unsetConfigValueAtPath as N, setConfigOverride as O, getTrustedSafeBinDirs as P, splitShellArgs as Q, validateSafeBinArgv as R, isAvatarHttpUrl as S, validateJsonSchemaValue as T, DEFAULT_SAFE_BINS as U, isWindowsPlatform as V, matchAllowlist as W, unwrapKnownDispatchWrapperInvocation as X, isShellWrapperExecutable as Y, unwrapKnownShellMultiplexerInvocation as Z, getBlockedNetworkModeReason as _, resolveConfigSnapshotHash as a, resolveSlackNativeStreaming as at, AVATAR_MAX_BYTES as b, TELEGRAM_COMMAND_NAME_PATTERN as c, DEFAULT_SUBAGENT_MAX_SPAWN_DEPTH as ct, DEFAULT_IMESSAGE_ATTACHMENT_ROOTS as d, resolveOwnerDisplaySetting as dt, normalizeSafeBinProfileFixtures as et, isInboundPathAllowed as f, normalizeScpRemoteHost as g, resolveIMessageRemoteAttachmentRoots as h, readConfigFileSnapshotForWrite as i, resolveDiscordPreviewStreamMode as it, parseConfigPath as j, unsetConfigOverride as k, normalizeTelegramCommandName as l, resolveAgentMaxConcurrent as lt, resolveIMessageAttachmentRoots as m, loadConfig as n, isSafeExecutableValue as nt, writeConfigFile as o, resolveSlackStreamingMode as ot, mergeInboundPathRoots as p, extractShellWrapperInlineCommand as q, readConfigFileSnapshot as r, mapStreamingModeToSlackLegacyDraftStreamMode as rt, validateConfigObjectWithPlugins as s, resolveTelegramPreviewStreamMode as st, createConfigIO as t, resolveSafeBinProfiles as tt, resolveTelegramCustomCommands as u, VERSION as ut, parseDurationMs as v, isSupportedLocalAvatarExtension as w, isAvatarDataUrl as x, parseByteSize as y, analyzeShellCommand as z };