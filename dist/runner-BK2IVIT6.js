import { D as runExec, F as resolveAgentModelPrimaryValue, P as resolveAgentModelFallbackValues } from "./agent-scope-DxSdR-i1.js";
import { $ as shouldLogVerbose, X as logVerbose, t as createSubsystemLogger, ut as resolvePreferredPowPowTmpDir } from "./subsystem-J2JHz_PH.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolvePowPowAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-BIieOTxJ.js";
import { t as normalizeChatType } from "./chat-type-BKe459rw.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-BV6UX3uC.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-ctWck2-F.js";
import { t as describeImageWithModel, w as ensurePowPowModelsJson } from "./image-oFVVIokh.js";
...
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-B_ohurCO.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DQnj7CO7.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CCkKmcns.js")).ensurePiAuthJsonFromAuthProfiles(resolvePowPowAgentDir());
