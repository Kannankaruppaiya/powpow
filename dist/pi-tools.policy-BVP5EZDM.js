...
import { T as resolveThreadParentSessionKey, l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-DXmKFT2p.js";
import { kt as DEFAULT_SUBAGENT_MAX_SPAWN_DEPTH } from "./config-B91e8u6L.js";
import { l as normalizeStringEntries, o as resolveChannelGroupToolsPolicy, t as getChannelDock } from "./dock-DaMhmHr_.js";
import { l as normalizeMessageChannel } from "./message-channel-DYK7E7vt.js";
import { S as normalizeToolName, T as matchesAnyGlobPattern, w as compileGlobPatterns, x as expandToolGroups } from "./sandbox-Vr4z2IvO.js";
...
function resolveEffectiveAllowFromLists(params) {
	...
	const configGroupAllowFrom = normalizeStringEntries(Array.isArray(params.groupAllowFrom) ? params.groupAllowFrom : void 0);
	const storeAllowFrom = params.dmPolicy === "allowlist" ? [] : normalizeStringEntries(Array.isArray(params.storeAllowFrom) ? params.storeAllowFrom : void 0);
	return {
		effectiveAllowFrom: normalizeStringEntries([...configAllowFrom, ...storeAllowFrom]),
		effectiveGroupAllowFrom: normalizeStringEntries([...configGroupAllowFrom.length > 0 ? configGroupAllowFrom : configAllowFrom, ...storeAllowFrom])
	};
}
...
//#endregion
export { resolveSubagentToolPolicy as a, resolveDmGroupAccessWithLists as c, resolveGroupToolPolicy as i, isToolAllowedByPolicies as n, pickSandboxToolPolicy as o, resolveEffectiveToolPolicy as r, resolveDmAllowState as s, filterToolsByPolicy as t };