...
import { i as pruneDiagnosticSessionStates, r as getDiagnosticSessionState, t as diagnosticSessionStates } from "./diagnostic-session-state-DmrztgHU.js";

//#region src/infra/diagnostic-events.ts
function getDiagnosticEventsState() {
	const globalStore = globalThis;
	if (!globalStore.__PowPowDiagnosticEventsState) globalStore.__PowPowDiagnosticEventsState = {
		seq: 0,
		listeners: /* @__PURE__ */ new Set(),
		dispatchDepth: 0
	};
	return globalStore.__PowPowDiagnosticEventsState;
}
...
function startDiagnosticHeartbeat() {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-BmBXYvP8.js").then((n) => n.t).then(({ pruneStaleCommandPolls }) => {
