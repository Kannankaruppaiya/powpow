import { r as STATE_DIR } from "./paths-BJtes5yu.js";
import { _ as CHANNEL_IDS, f as defaultRuntime, t as createSubsystemLogger } from "./subsystem-DXlyH4H4.js";
import { v as resolveUserPath } from "./utils-BWJH7VRh.js";
import { t as formatCliCommand } from "./command-format-DRH7uGKn.js";
import { C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, T as DEFAULT_USER_FILENAME, _ as DEFAULT_AGENT_WORKSPACE_DIR, b as DEFAULT_IDENTITY_FILENAME, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, m as resolveSessionAgentId, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-Ac0Vygcn.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-DXmKFT2p.js";
import { d as resolveSandboxInputPath, f as resolveSandboxPath, h as assertNoPathAliasEscape, m as PATH_ALIAS_POLICIES, o as syncSkillsToWorkspace, v as sanitizeEnvVars } from "./skills-D7zMUUWl.js";
import { S as getBlockedNetworkModeReason, i as loadConfig } from "./config-B91e8u6L.js";
import { Q as resolveAgentMainSessionKey, Z as canonicalizeMainSessionAlias, z as acquireSessionWriteLock } from "./sessions-DGKLiJDU.js";
import { r as isLoopbackHost } from "./net-CliLiAjH.js";
import { a as resolveCoreToolProfilePolicy, t as CORE_TOOL_GROUPS } from "./tool-catalog-7y19qjm_.js";
import { O as DEFAULT_BROWSER_EVALUATE_ENABLED, j as DEFAULT_POWPOW_BROWSER_PROFILE_NAME, k as DEFAULT_POWPOW_BROWSER_COLOR } from "./chrome-CwN6j-nF.js";
import { a as resolveProfile, o as ensureBrowserControlAuth, r as registerBrowserRoutes, s as resolveBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-B-VoITNb.js";
...
const DEFAULT_SANDBOX_COMMON_IMAGE = "powpow-sandbox-common:bookworm-slim";
