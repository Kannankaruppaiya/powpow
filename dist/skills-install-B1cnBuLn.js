import { c as ensureDir, g as resolveConfigDir, y as resolveUserPath } from "./utils-C9Yd70Dr.js";
import { t as runCommandWithTimeout } from "./exec-7lv95ExR.js";
import { d as hasBinary } from "./frontmatter-D24yp6Oh.js";
import { C as resolveSkillKey, i as loadWorkspaceSkillEntries, t as resolveSkillsInstallPreferences } from "./skills-CpGz3h87.js";
...
import { a as extractArchive$1, d as resolveArchiveOutputPath, f as stripArchivePath, p as validateArchiveEntryPath, r as safePathSegmentHashed, u as isWindowsDrivePath } from "./install-safe-path-DE9lNTM4.js";
...
async function collectSkillInstallScanWarnings(entry) {
	...
	try {
		...
		} else if (summary.warn > 0) warnings.push(`Skill "${skillName}" has ${summary.warn} suspicious code pattern(s). Run "PowPow security audit --deep" for details.`);
	} catch (err) {
		warnings.push(`Skill "${skillName}" code safety scan failed (${String(err)}). Installation continues; run "PowPow security audit --deep" after install.`);
	}
	return warnings;
}
