...
import { At as normalizeSecretInput } from "./auth-profiles-KPMal-k-.js";
...
import { _ as resolveNodeManagerOptions, r as detectBinary } from "./onboard-helpers-BNEaJ_0q.js";
...
async function setupSkills(cfg, workspaceDir, runtime, prompter) {
	...
	if (installable.length > 0) {
		...
		for (const name of selected) {
			...
			runtime.log(`Tip: run \`${formatCliCommand("PowPow doctor")}\` to review skills + requirements.`);
			runtime.log("Docs: https://docs.PowPow.ai/skills");
		}
	}
