...
import { D as danger, H as getResolvedLoggerSettings, N as setVerbose, u as isRecord, z as theme } from "./utils-BWJH7VRh.js";
import "./boolean-YY6K2DFz.js";
import { S as loadAuthProfileStore } from "./auth-profiles-KPMal-k-.js";
import { t as formatCliCommand } from "./command-format-DRH7uGKn.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-Ac0Vygcn.js";
import { h as normalizeAccountId, m as DEFAULT_ACCOUNT_ID } from "./session-key-DXmKFT2p.js";
...
import { i as loadConfig, l as writeConfigFile, o as readConfigFileSnapshot } from "./config-B91e8u6L.js";
import "./env-vars-D53NnL-N.js";
import "./dock-DaMhmHr_.js";
import "./message-channel-DYK7E7vt.js";
import "./sessions-DGKLiJDU.js";
import { d as resolveTelegramAccount, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-CPaMeorQ.js";
...
import { i as createSlackWebClient } from "./send-D7Pm0pyK.js";
import { $ as fetchChannelPermissionsDiscord, it as parseDiscordTarget } from "./send-BglfZujd.js";
import { hn as formatUsageReportLines, mn as loadProviderUsageSummary, v as deleteTelegramUpdateOffset } from "./subagent-registry-DXZuSN83.js";
import "./paths-BB4B9o0x.js";
import "./chat-envelope-9mWFsNOQ.js";
import "./client-FngVpCQH.js";
import { n as callGateway } from "./call-Dy4jPY6_.js";
...
import { a as listChannelPluginCatalogEntries } from "./plugin-auto-enable-CRRq2Feu.js";
...
import { t as createClackPrompter } from "./clack-prompter-u4SxqKXZ.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BS0Qj8Nb.js";
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-qf5_H35h.js";
import { n as buildAgentSummaries } from "./agents.config-DEzcq91l.js";
...
import { a as reloadOnboardingPluginRegistry, i as ensureOnboardingPluginInstalled, r as setupChannels } from "./onboard-channels-02EDsJ--.js";
import { t as buildChannelAccountSnapshot } from "./status-C4MeiRud.js";
import { t as parseLogLine } from "./parse-log-line-_Fw5Q0XY.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-B_hfqcmH.js";
import "./plugin-registry-BoiHUSmO.js";
import { t as formatCliChannelOptions } from "./channel-options-Ckyvx0_Z.js";
...
function formatGatewayChannelsStatusLines(payload) {
	...
	if (issues.length > 0) {
		...
		lines.push(`- Run: ${formatCliCommand("PowPow doctor")}`);
		lines.push("");
	}
...
function registerChannelsCli(program) {
	...
	const channels = program.command("channels").description("Manage connected chat channels and accounts").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		["PowPow channels list", "List configured channels and auth profiles."],
		["PowPow channels status --probe", "Run channel status checks and probes."],
		["PowPow channels add --channel telegram --token <token>", "Add or update a channel account non-interactively."],
		["PowPow channels login --channel whatsapp", "Link a WhatsApp Web account."]
	])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/channels", "docs.PowPow.ai/cli/channels")}\n`);
