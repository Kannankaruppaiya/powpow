...
import { m as DEFAULT_ACCOUNT_ID, s as normalizeAgentId } from "./session-key-DXmKFT2p.js";
import { o as readConfigFileSnapshot } from "./config-B91e8u6L.js";
...
async function requireValidConfigSnapshot(runtime) {
	...
	if (snapshot.exists && !snapshot.valid) {
		...
		runtime.error(`Fix the config or run ${formatCliCommand("PowPow doctor")}.`);
		runtime.exit(1);
		return null;
	}
