...
function gatewayInstallErrorHint(platform = process.platform) {
	return platform === "win32" ? "Tip: rerun from an elevated PowerShell (Start → type PowerShell → right-click → Run as administrator) or skip service install." : `Tip: rerun \`${formatCliCommand("PowPow gateway install")}\` after fixing the error.`;
}

//#endregion
export { buildNodeServiceEnvironment as a, isVersionManagedNodePath as c, resolveSystemNodeInfo as d, resolveSystemNodePath as f, isNodeRuntime as h, emitNodeRuntimeWarning as i, renderSystemNodeWarning as l, isBunRuntime as m, gatewayInstallErrorHint as n, getMinimalServicePathPartsFromEnv as o, resolveNodeProgramArguments as p, resolveGatewayDevMode as r, isSystemNodePath as s, buildGatewayInstallPlan as t, resolvePreferredNodePath as u };