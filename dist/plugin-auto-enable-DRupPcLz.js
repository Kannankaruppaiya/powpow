import { d as isRecord, t as CONFIG_DIR, y as resolveUserPath } from "./utils-C9Yd70Dr.js";
import { S as listChatChannels, T as normalizeChatChannelId, x as getChatChannelMeta } from "./subsystem-A8uKC1In.js";
import { u as normalizeProviderId } from "./model-selection-DAT49TVG.js";
import { n as MANIFEST_KEY } from "./legacy-names-SFMgq_oD.js";
import { n as loadPluginManifestRegistry, r as discoverPowPowPlugins } from "./manifest-registry-jY2uQzFh.js";
import { t as hasAnyWhatsAppAuth } from "./accounts-CWi8B8Jm.js";
...
const ENV_CATALOG_PATHS = ["POWPOW_PLUGIN_CATALOG_PATHS", "POWPOW_MPM_CATALOG_PATHS"];
...
function listChannelPluginCatalogEntries(options = {}) {
	const discovery = discoverPowPowPlugins({ workspaceDir: options.workspaceDir });
