...
import { t as CONFIG_PATH } from "./paths-BJtes5yu.js";
import { L as colorize, R as isRich$1, x as shortenHomePath, z as theme } from "./utils-BWJH7VRh.js";
import { B as parseModelRef, Ct as getCustomProviderApiKey, Dt as resolveEnvApiKey, E as resolvePowPowAgentDir, Et as resolveAwsSdkEnvVarName, It as shouldEnableShellEnvFallback, Jt as DEFAULT_MODEL, K as resolveModelRefFromString, L as modelKey, M as buildModelAliasIndex, N as findNormalizedProviderValue, T as resolveAuthStorePathForDisplay, Tt as resolveApiKeyForProvider, U as resolveConfiguredModelRef, W as resolveDefaultModelForAgent, Xt as resolveAuthProfileDisplayLabel, Yt as DEFAULT_PROVIDER, g as listProfilesForProvider, jt as getShellEnvAppliedKeys, n as resolveAuthProfileOrder, s as resolveProfileUnusableUntilForDisplay, v as setAuthProfileOrder, x as ensureAuthProfileStore, y as upsertAuthProfile, z as normalizeProviderId } from "./auth-profiles-KPMal-k-.js";
import { t as formatCliCommand } from "./command-format-DRH7uGKn.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-Ac0Vygcn.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-CQsSYJmZ.js";
import { r as resolveForwardCompatModel } from "./model-CCop3Cpo.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-Do3xMEtM.js";
import { T as parseDurationMs, i as loadConfig } from "./config-B91e8u6L.js";
import { $t as formatRemainingShort, Qt as buildAuthHealthSummary, Xt as maskApiKey, Zt as DEFAULT_OAUTH_WARN_MS, _n as resolveUsageProviderId, bt as describeFailoverError, gn as formatUsageWindowSummary, mn as loadProviderUsageSummary, s as runEmbeddedPiAgent } from "./subagent-registry-DXZuSN83.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-BB4B9o0x.js";
import { t as ensurePowPowModelsJson } from "./models-config-CQKypJwH.js";
import { n as loadModelCatalog } from "./model-catalog-ExB4NYZv.js";
import { r as withProgressTotals } from "./progress-DF7PrFZS.js";
...
import { n as redactSecrets } from "./format-DPV8QZPM.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-07DAmQ26.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-xlDYHYGE.js";
import { n as logConfigUpdated } from "./logging-x1Y0rmXr.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-E8KJXle6.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-B91e8u6L.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./auth-profiles-KPMal-k-.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CCop3Cpo.js").then((n) => n.t);
