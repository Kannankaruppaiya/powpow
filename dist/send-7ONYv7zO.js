...
import { _ as expandHomePrefix } from "./paths-BJtes5yu.js";
import { t as createSubsystemLogger } from "./subsystem-DXlyH4H4.js";
import { D as danger, j as logVerbose, t as CONFIG_DIR } from "./utils-BWJH7VRh.js";
import { r as isTruthyEnvValue } from "./entry.js";
import { Tt as resolveTelegramPreviewStreamMode, i as loadConfig, l as writeConfigFile, s as readConfigFileSnapshotForWrite } from "./config-B91e8u6L.js";
import { d as resolveTelegramAccount } from "./plugins-CPaMeorQ.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-BsCVl39S.js";
import { n as redactSensitiveText } from "./redact-CAjBvpi8.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-BpyuHard.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-BIAGpTUC.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-JyKcvRos.js";
...
import { t as resolveFetch } from "./fetch-CVaUMMnD.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-Drlj9sA4.js";
import { n as normalizePollInput } from "./polls-DTGTrGlo.js";
import { n as isWSL2Sync } from "./wsl-CvQfS6aU.js";
...
//#endregion
export { resolveTelegramTargetChatType as $, buildTypingThreadParams as A, resolveTelegramStreamMode as B, buildGroupLabel as C, buildTelegramGroupPeerId as D, buildTelegramGroupFrom as E, normalizeForwardedContext as F, resolveSenderAllowMatch as G, isSenderAllowed as H, resolveTelegramForumThreadId as I, mergeAllowFromSources as J, firstDefined as K, resolveTelegramGroupAllowFromContext as L, expandTextLinks as M, extractTelegramLocation as N, buildTelegramParentPeer as O, hasBotMention as P, parseTelegramTarget as Q, resolveTelegramMediaPlaceholder as R, withTelegramApiErrorLogging as S, buildSenderName as T, normalizeAllowFrom as U, resolveTelegramThreadSpec as V, normalizeAllowFromWithStore as W, toLocationContext as X, formatLocationText as Y, isVoiceCompatibleAudio as Z, markdownToTelegramHtml as _, reactMessageTelegram as a, resolveTelegramFetch as b, sendStickerTelegram as c, loadCronStore as d, resolveCronStorePath as f, markdownToTelegramChunks as g, isRecoverableTelegramNetworkError as h, editMessageTelegram as i, describeReplyTarget as j, buildTelegramThreadParams as k, send_exports as l, wasSentByBot as m, createForumTopicTelegram as n, sendMessageTelegram as o, saveCronStore as p, isSenderIdAllowed as q, deleteMessageTelegram as r, sendPollTelegram as s, buildInlineKeyboard as t, resolveTelegramVoiceSend as u, renderTelegramHtmlText as v, buildSenderLabel as w, splitTelegramCaption as x, wrapFileReferencesInHtml as y, resolveTelegramReplyId as z };