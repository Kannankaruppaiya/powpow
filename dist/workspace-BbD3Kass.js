...
import { $ as shouldLogVerbose, I as pathExists, J as danger, Y as info, Z as logVerboseConsole, ot as getLogger, r as defaultRuntime, t as createSubsystemLogger, tt as warn, z as resolveUserPath } from "./subsystem-3xhEFOyH.js";
import { b as isSubagentSessionKey, y as isCronSessionKey } from "./session-key-YGVrIVO5.js";
...
//#endregion
//#region src/infra/powpow-root.ts
const CORE_PACKAGE_NAMES = new Set(["PowPow"]);
...
async function resolvePowPowPackageRoot(opts) {
...
function resolvePowPowPackageRootSync(opts) {
	for (const candidate of buildCandidates(opts)) {
...
async function resolveWorkspaceTemplateDir(opts) {
	...
	resolvingTemplateDir = (async () => {
		...
		const packageRoot = await resolvePowPowPackageRoot({
			moduleUrl,
			argv1,
			cwd
		});
...
const WORKSPACE_STATE_DIRNAME = ".PowPow";
...
//#endregion
export { logWarn as S, runExec as _, DEFAULT_IDENTITY_FILENAME as a, logError as b, DEFAULT_USER_FILENAME as c, loadExtraBootstrapFiles as d, loadWorkspaceBootstrapFiles as f, runCommandWithTimeout as g, resolvePowPowPackageRootSync as h, DEFAULT_HEARTBEAT_FILENAME as i, ensureAgentWorkspace as l, resolvePowPowPackageRoot as m, DEFAULT_AGENT_WORKSPACE_DIR as n, DEFAULT_SOUL_FILENAME as o, resolveDefaultAgentWorkspaceDir as p, DEFAULT_BOOTSTRAP_FILENAME as r, DEFAULT_TOOLS_FILENAME as s, DEFAULT_AGENTS_FILENAME as t, filterBootstrapFilesForSession as u, spawnWithFallback as v, logInfo as x, logDebug as y };