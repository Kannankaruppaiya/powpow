import { p as normalizeSkillFilter } from "./agent-scope-LV16AGcF.js";
import { T as CONFIG_DIR, t as createSubsystemLogger, ut as resolvePreferredPowPowTmpDir, z as resolveUserPath } from "./subsystem-3xhEFOyH.js";
import { h as resolvePowPowPackageRootSync } from "./workspace-BbD3Kass.js";
import { F as isDangerousHostEnvVarName } from "./model-selection-MeurW_4a.js";
import { c as resolveMemorySlotDecision, o as normalizePluginsConfig, s as resolveEffectiveEnableState, t as loadPluginManifestRegistry } from "./manifest-registry-R4d8uSqf.js";
import { a as resolvePowPowManifestBlock, c as resolvePowPowManifestRequires, d as hasBinary, f as isConfigPathTruthyWithDefaults, i as parsePowPowManifestInstallBase, l as parseFrontmatterBlock, n as normalizeStringList, o as resolvePowPowManifestInstall, r as parseFrontmatterBool, s as resolvePowPowManifestOs, t as getFrontmatterString, u as evaluateRuntimeEligibility } from "./frontmatter-CM2DP0fv.js";
...
async function assertNoPathAliasEscape(params) {
	...
	if (relative) {
		...
		for (let idx = 0; idx < parts.length; idx += 1) {
			...
			try {
				if (!(await fs.lstat(current)).isSymbolicLink()) continue;
