import { g as resolveStateDir, i as isNixMode, m as resolveOAuthDir, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-BJtes5yu.js";
import { f as defaultRuntime } from "./subsystem-DXlyH4H4.js";
import { b as shortenHomeInString, g as resolveHomeDir, v as resolveUserPath, z as theme } from "./utils-BWJH7VRh.js";
import "./boolean-YY6K2DFz.js";
import "./auth-profiles-KPMal-k-.js";
import { t as formatCliCommand } from "./command-format-DRH7uGKn.js";
import { A as resolveDefaultAgentWorkspaceDir } from "./agent-scope-Ac0Vygcn.js";
...
import { f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, o as formatControlUiSshHint } from "./onboard-helpers-BNEaJ_0q.js";
...
import "./completion-cli-DJ2PhZXh.js";
...
import "./channel-account-context-23ILPOVs.js";
import "./session-dirs-D4HEmQCv.js";
...
import "./doctor-completion-DW6-o8oI.js";
...
async function dashboardCommand(runtime = defaultRuntime, options = {}) {
	...
	const token = cfg.gateway?.auth?.token ?? process.env.POWPOW_GATEWAY_TOKEN ?? "";
	...
	if (opened) runtime.log("Opened in your browser. Keep that tab to control PowPow.");
...
async function resetCommand(runtime, opts) {
	...
	if (scope === "config+creds+sessions") {
		...
		runtime.log(`Next: ${formatCliCommand("PowPow onboard --install-daemon")}`);
		return;
	}
	if (scope === "full") {
...
async function removeMacApp(runtime, dryRun) {
	...
	await removePath("/Applications/PowPow.app", runtime, {
		dryRun,
		label: "/Applications/PowPow.app"
	});
}
