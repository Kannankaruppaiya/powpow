import { K as resolveModelRefFromString, L as modelKey, M as buildModelAliasIndex, Yt as DEFAULT_PROVIDER } from "./auth-profiles-KPMal-k-.js";
import { t as formatCliCommand } from "./command-format-DRH7uGKn.js";
import { P as toAgentModelListLike, r as listAgentIds } from "./agent-scope-Ac0Vygcn.js";
...
function resolveKnownAgentId(params) {
	...
	if (!listAgentIds(params.cfg).includes(agentId)) throw new Error(`Unknown agent id "${raw}". Use "${formatCliCommand("PowPow agents list")}" to see configured agents.`);
	return agentId;
}
