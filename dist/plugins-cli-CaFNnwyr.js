...
import { b as shortenHomeInString, h as resolveConfigDir, v as resolveUserPath, x as shortenHomePath, z as theme } from "./utils-BWJH7VRh.js";
...
import { m as defaultSlotIdForKey, p as applyExclusiveSlotSelection, s as resolveBundledPluginsDir, t as clearPluginManifestRegistryCache } from "./manifest-registry-C9O9KUb3.js";
...
import { n as setPluginEnabledInConfig, t as enablePluginInConfig } from "./enable-Bup-tbnL.js";
import { c as resolveArchiveKind } from "./install-safe-path-DoxY3Jl3.js";
import "./npm-registry-spec-LTflfgy4.js";
import "./skill-scanner-Cs4mlgip.js";
import { a as resolvePluginInstallDir, i as installPluginFromPath, n as recordPluginInstall, r as installPluginFromNpmSpec } from "./installs-DNXwXVSR.js";
import { t as renderTable } from "./table-DfxW26j_.js";
import { n as resolvePinnedNpmInstallRecordForCli, r as buildPluginStatusReport } from "./npm-resolution-Cw09qyEr.js";
import { n as updateNpmInstalledPlugins } from "./update-QFbdj3tL.js";
...
function resolvePluginSourceRoots(params) {
	return {
		...
		workspace: params.workspaceDir ? path.join(params.workspaceDir, ".PowPow", "extensions") : void 0
	};
}
...
function registerPluginsCli(program) {
	const plugins = program.command("plugins").description("Manage PowPow plugins and extensions").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/plugins", "docs.PowPow.ai/cli/plugins")}\n`);
	...
	plugins.command("doctor").description("Report plugin load issues").action(() => {
		...
		const docs = formatDocsLink("/plugin", "docs.PowPow.ai/plugin");
		lines.push("");
