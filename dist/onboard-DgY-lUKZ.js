...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-A8uKC1In.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE } from "./onboard-helpers-D8_1U5gk.js";
...
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CqHTDrIJ.js";
import { t as runOnboardingWizard } from "./onboarding-Daiy9lRa.js";
import { n as logConfigUpdated } from "./logging-5L92glm9.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-CnajAE1m.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CMwO5c1b.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DBeCcV_6.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-C33hSJdl.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-CTkGTirK.js").then((n) => n.i);
