...
import { p as normalizeE164 } from "./utils-BWJH7VRh.js";
import { O as resolveProcessScopedMap, k as isPidAlive } from "./auth-profiles-KPMal-k-.js";
import { c as normalizeMainKey, g as normalizeOptionalAccountId, l as resolveAgentIdFromSessionKey, r as buildAgentMainSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-DXmKFT2p.js";
import { E as parseByteSize, T as parseDurationMs, i as loadConfig } from "./config-B91e8u6L.js";
import { c as normalizeHyphenSlug, t as getChannelDock } from "./dock-DaMhmHr_.js";
import { c as listDeliverableMessageChannels, l as normalizeMessageChannel } from "./message-channel-DYK7E7vt.js";
import { t as normalizeChatType } from "./chat-type-3FRbbjbq.js";
import { n as resolveConversationLabel } from "./conversation-label-_lS-tEK2.js";
import { r as normalizeChannelId } from "./plugins-CPaMeorQ.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, n as resolveDefaultSessionStorePath, o as resolveSessionTranscriptPathInDir, r as resolveSessionFilePath, s as resolveSessionTranscriptsDir, t as SAFE_SESSION_ID_RE, u as validateSessionId } from "./paths-BB4B9o0x.js";
import { r as hasInterSessionUserProvenance } from "./input-provenance-CUAvV3g8.js";
import { n as stripMessageIdHints, o as extractToolCallNames, r as stripInboundMetadata, s as hasToolCall, t as stripEnvelope } from "./chat-envelope-9mWFsNOQ.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-B_sHgbkA.js";
...
function resolveSessionTranscriptCandidates(sessionId, storePath, sessionFile, agentId) {
	...
	const legacyDir = path.join(home, ".PowPow", "sessions");
...
function getSessionStoreTtl() {
	return resolveCacheTtlMs({
		envValue: process.env.POWPOW_SESSION_CACHE_TTL_MS,
...
/**
* Resolve maintenance settings from PowPow.json (`session.maintenance`).
...
//#endregion
export { resolveExplicitAgentSessionKey as $, readSessionMessages as A, cleanStaleLockFiles as B, normalizeDeliveryContext as C, archiveSessionTranscripts as D, archiveFileOnDisk as E, stripEnvelopeFromMessages as F, resolveSessionResetPolicy as G, resolveSessionKey as H, parseInlineDirectives as I, DEFAULT_RESET_TRIGGERS as J, resolveSessionResetType as K, stripInlineDirectiveTagsForDisplay as L, readSessionTitleFieldsFromTranscript as M, resolveSessionTranscriptCandidates as N, capArrayByJsonBytes as O, stripEnvelopeFromMessage as P, resolveAgentMainSessionKey as Q, stripInlineDirectiveTagsFromMessageForDisplay as R, mergeDeliveryContext as S, normalizeAccountId as T, evaluateSessionFreshness as U, resolveSessionLockMaxHoldFromTimeout as V, resolveChannelResetConfig as W, setSessionRuntimeModel as X, resolveFreshSessionTotalTokens as Y, canonicalizeMainSessionAlias as Z, enforceSessionDiskBudget as _, resolveMirroredTranscriptText as a, isPrimarySessionTranscriptFileName as at, deliveryContextFromSession as b, loadSessionStore as c, recordSessionMetaFromInbound as d, resolveMainSessionKey as et, resolveMaintenanceConfig as f, updateSessionStoreEntry as g, updateSessionStore as h, appendAssistantMessageToSessionTranscript as i, formatSessionArchiveTimestamp as it, readSessionPreviewItemsFromTranscript as j, cleanupArchivedSessionTranscripts as k, pruneStaleEntries as l, updateLastRoute as m, extractDeliveryInfo as n, deriveSessionMetaPatch as nt, resolveAndPersistSessionFile as o, buildGroupDisplayName as ot, saveSessionStore as p, resolveThreadFlag as q, parseSessionThreadInfo as r, snapshotSessionOrigin as rt, capEntryCount as s, resolveGroupSessionKey as st, sessions_exports as t, resolveMainSessionKeyFromConfig as tt, readSessionUpdatedAt as u, isCacheEnabled as v, normalizeSessionDeliveryFields as w, deliveryContextKey as x, resolveCacheTtlMs as y, acquireSessionWriteLock as z };