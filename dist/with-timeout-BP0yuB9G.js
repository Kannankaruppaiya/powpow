...
import { at as extractShellWrapperCommand, dt as unwrapDispatchWrappersForResolution, i as loadConfig, pt as unwrapKnownShellMultiplexerInvocation, st as hasEnvManipulationBeforeShellWrapper, ut as normalizeExecutableToken } from "./config-B91e8u6L.js";
import { i as resolveBrowserConfig, o as ensureBrowserControlAuth, r as registerBrowserRoutes, t as createBrowserRouteContext } from "./server-context-B-VoITNb.js";
import { t as ensureExtensionRelayForProfiles } from "./server-lifecycle-Bjvkjvkd.js";
...
function fallbackHostName() {
	return os.hostname().replace(/\.local$/i, "").trim() || "PowPow";
}
