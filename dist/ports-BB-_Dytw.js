import { F as shouldLogVerbose, L as warn, O as danger, k as info } from "./utils-C9Yd70Dr.js";
import { f as defaultRuntime } from "./subsystem-A8uKC1In.js";
import { i as logDebug, t as runCommandWithTimeout } from "./exec-7lv95ExR.js";
import { t as formatCliCommand } from "./command-format-DpXmP5EG.js";
import { a as isErrno } from "./errors-Adli4uDW.js";
...
async function handlePortError(err, port, context, runtime = defaultRuntime) {
	if (err instanceof PortInUseError || isErrno(err) && err.code === "EADDRINUSE") {
		...
		if (details) {
			...
			if (/PowPow|src\/index\.ts|dist\/index\.js/.test(details)) runtime.error(warn("It looks like another PowPow instance is already running. Stop it or pick a different port."));
		}
...
//#endregion
export { inspectPortUsage as a, formatPortDiagnostics as c, handlePortError as i, describePortOwner as n, resolveLsofCommandSync as o, ensurePortAvailable as r, classifyPortListener as s, PortInUseError as t };