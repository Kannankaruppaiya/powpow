...
import { $ as shouldLogVerbose, X as logVerbose, t as createSubsystemLogger, ut as resolvePreferredPowPowTmpDir } from "./subsystem-COVUh7Yl.js";
import { _ as runExec } from "./workspace-DqldSWWG.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolvePowPowAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-CtYSbl7o.js";
import { t as normalizeChatType } from "./chat-type-CH3W-zKy.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-Dvd5i2nB.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-x2H1-MTw.js";
import { t as describeImageWithModel, w as ensurePowPowModelsJson } from "./image-pSyUJfmN.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-COs0BPum.js";
import { n as fetchWithTimeout } from "./fetch-timeout-BVa_Fx_T.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-D835LfDO.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DuvQnRTk.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DZrt2PIy.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-BC2FPyf3.js")).ensurePiAuthJsonFromAuthProfiles(resolvePowPowAgentDir());
...
async function runCliEntry(params) {
	...
	const outputDir = await fs.mkdtemp(path.join(resolvePreferredPowPowTmpDir(), "powpow-media-cli-"));
