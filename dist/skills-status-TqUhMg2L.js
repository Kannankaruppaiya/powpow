...
import { t as evaluateEntryRequirementsForCurrentPlatform } from "./entry-status-C1_OqfVp.js";
import { d as hasBinary } from "./frontmatter-B7nss1o8.js";
import { S as resolveSkillConfig, b as isConfigPathTruthy, c as resolveBundledSkillsDir, i as loadWorkspaceSkillEntries, t as resolveSkillsInstallPreferences, x as resolveBundledAllowlist, y as isBundledSkillAllowed } from "./skills-D7zMUUWl.js";
...
function buildSkillStatus(entry, config, prefs, eligibility, bundledNames) {
	...
	const bundled = bundledNames && bundledNames.size > 0 ? bundledNames.has(entry.skill.name) : entry.skill.source === "powpow-bundled";
