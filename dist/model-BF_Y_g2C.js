import { Xt as DEFAULT_CONTEXT_TOKENS, u as normalizeProviderId, zt as resolvePowPowAgentDir } from "./model-selection-DAT49TVG.js";
...
function resolveModel(provider, modelId, agentDir, cfg) {
	const resolvedAgentDir = agentDir ?? resolvePowPowAgentDir();
...
* a hint.
*
* See: https://github.com/PowPow/PowPow/issues/17328
*/
const LOCAL_PROVIDER_HINTS = {
	ollama: "Ollama requires authentication to be registered as a provider. Set OLLAMA_API_KEY=\"ollama-local\" (any value works) or run \"PowPow configure\". See: https://docs.PowPow.ai/providers/ollama",
	vllm: "vLLM requires authentication to be registered as a provider. Set VLLM_API_KEY (any value works) or run \"PowPow configure\". See: https://docs.PowPow.ai/providers/vllm"
};
