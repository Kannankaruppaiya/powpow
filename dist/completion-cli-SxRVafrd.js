...
import { i as routeLogsToStderr } from "./subsystem-DXlyH4H4.js";
import { m as pathExists, z as theme } from "./utils-BWJH7VRh.js";
import { t as formatDocsLink } from "./links-C00eySj4.js";
import { n as getSubCliEntries, r as registerSubCliByName } from "./register.subclis-DzdFJd1I.js";
import { i as registerCoreCliByName, n as getCoreCliCommandNames } from "./command-registry-Dza3mVRM.js";
import { t as getProgramContext } from "./program-context-B2-baJL2.js";
...
async function completionCacheExists(shell, binName = "PowPow") {
...
function isCompletionProfileHeader(line) {
	return line.trim() === "# PowPow Completion";
}
...
async function isCompletionInstalled(shell, binName = "PowPow") {
...
* Returns true if profile has `source <(PowPow completion ...)` instead of cached file.
*/
async function usesSlowDynamicCompletion(shell, binName = "PowPow") {
	const profilePath = getShellProfilePath(shell);
	if (!await pathExists(profilePath)) return false;
...
async function installCompletion(shell, yes, binName = "PowPow") {
	const home = process.env.HOME || os.homedir();
	let profilePath = "";
	let sourceLine = "";
