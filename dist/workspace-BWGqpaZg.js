...
import { a as isPathInsideWithRealpath, n as MANIFEST_KEY } from "./legacy-names-SFMgq_oD.js";
...
function shouldIncludeHook(params) {
	...
	if (!(entry.hook.source === "powpow-plugin") && hookConfig?.enabled === false) return false;
...
function resolveBundledHooksDir() {
	const override = process.env.POWPOW_BUNDLED_HOOKS_DIR?.trim();
