...
import { R as isRich, z as theme } from "./utils-BWJH7VRh.js";
...
import { c as readExecApprovalsSnapshot, p as saveExecApprovals } from "./exec-approvals-Bs-EcVjz.js";
import { t as formatDocsLink } from "./links-C00eySj4.js";
import "./progress-DF7PrFZS.js";
import { n as callGatewayFromCli } from "./gateway-rpc-CB5mPCiK.js";
import "./systemd-BBp3JvkT.js";
import "./service-DkDZ7shP.js";
import { t as renderTable } from "./table-DfxW26j_.js";
import { t as describeUnknownError } from "./shared-HMbrKQYz.js";
import { i as resolveNodeId, r as nodesCallOpts } from "./rpc-C4j2SLv_.js";
...
function registerExecApprovalsCli(program) {
	...
	const allowlist = approvals.command("allowlist").description("Edit the per-agent allowlist").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatExample("PowPow approvals allowlist add \"~/Projects/**/bin/rg\"", "Allowlist a local binary pattern for the main agent.")}\n${formatExample("PowPow approvals allowlist add --agent main --node <id|name|ip> \"/usr/bin/uptime\"", "Allowlist on a specific node/agent.")}\n${formatExample("PowPow approvals allowlist add --agent \"*\" \"/usr/bin/uname\"", "Allowlist for all agents (wildcard).")}\n${formatExample("PowPow approvals allowlist remove \"~/Projects/**/bin/rg\"", "Remove an allowlist pattern.")}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/approvals", "docs.PowPow.ai/cli/approvals")}\n`);
