...
import { a as resolveOAuthDir, c as expandHomePrefix, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-DGhxxd_R.js";
import { B as safeParseJson, J as danger, T as CONFIG_DIR, X as logVerbose, t as createSubsystemLogger } from "./subsystem-3xhEFOyH.js";
import { Z as withFileLock$1 } from "./model-selection-MeurW_4a.js";
import { t as isTruthyEnvValue } from "./env-dg1Vq6R_.js";
import { l as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-toi-1uUy.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-CIlRVMHI.js";
import { i as readConfigFileSnapshotForWrite, n as loadConfig, o as writeConfigFile, st as resolveTelegramPreviewStreamMode } from "./config-BVY11kC2.js";
import { t as redactSensitiveText } from "./redact-Bu0ABJUw.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-WCORuQlU.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-CPk6MmxS.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-K7daijXR.js";
import { t as renderMarkdownWithMarkers } from "./render-B1VqYyvo.js";
import { t as resolveFetch } from "./fetch-DPAIXoG3.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-DKMy0pAN.js";
import { n as normalizePollInput } from "./polls-BmymsJEe.js";
import { t as makeProxyFetch } from "./proxy-pPaHJt5e.js";
...
//#endregion
export { writeJsonFileAtomically as $, extractTelegramLocation as A, normalizeAllowFrom as B, buildTelegramGroupFrom as C, buildTypingThreadParams as D, buildTelegramThreadParams as E, resolveTelegramMediaPlaceholder as F, mergeAllowFromSources as G, resolveSenderAllowMatch as H, resolveTelegramReplyId as I, addChannelAllowFromStoreEntry as J, formatLocationText as K, resolveTelegramStreamMode as L, normalizeForwardedContext as M, resolveTelegramForumThreadId as N, describeReplyTarget as O, resolveTelegramGroupAllowFromContext as P, readJsonFileWithFallback as Q, resolveTelegramThreadSpec as R, buildSenderName as S, buildTelegramParentPeer as T, firstDefined as U, normalizeAllowFromWithStore as V, isSenderIdAllowed as W, removeChannelAllowFromStoreEntry as X, readChannelAllowFromStore as Y, upsertChannelPairingRequest as Z, resolveTelegramFetch as _, reactMessageTelegram as a, buildGroupLabel as b, sendStickerTelegram as c, wasSentByBot as d, getPairingAdapter as et, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, resolveTelegramTargetChatType as it, hasBotMention as j, expandTextLinks as k, send_exports as l, markdownToTelegramHtml as m, createForumTopicTelegram as n, isVoiceCompatibleAudio as nt, sendMessageTelegram as o, markdownToTelegramChunks as p, toLocationContext as q, deleteMessageTelegram as r, parseTelegramTarget as rt, sendPollTelegram as s, buildInlineKeyboard as t, listPairingChannels as tt, resolveTelegramVoiceSend as u, splitTelegramCaption as v, buildTelegramGroupPeerId as w, buildSenderLabel as x, withTelegramApiErrorLogging as y, isSenderAllowed as z };