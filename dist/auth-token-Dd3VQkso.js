...
import { B as buildTogetherModelDefinition, C as QIANFAN_DEFAULT_MODEL_ID, D as buildQianfanProvider, E as buildKimiCodingProvider, F as VENICE_DEFAULT_MODEL_REF, H as SYNTHETIC_DEFAULT_MODEL_REF, I as VENICE_MODEL_CATALOG, Jt as KILOCODE_BASE_URL, L as buildVeniceModelDefinition, Mt as upsertAuthProfile, O as buildXiaomiProvider, P as VENICE_BASE_URL, R as TOGETHER_BASE_URL, S as QIANFAN_BASE_URL, T as buildKilocodeProvider, U as SYNTHETIC_MODEL_CATALOG, V as SYNTHETIC_BASE_URL, W as buildSyntheticModelDefinition, Yt as KILOCODE_DEFAULT_MODEL_REF, ct as buildHuggingfaceModelDefinition, dt as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, ft as buildCloudflareAiGatewayModelDefinition, ot as HUGGINGFACE_BASE_URL, pt as resolveCloudflareAiGatewayBaseUrl, st as HUGGINGFACE_MODEL_CATALOG, u as normalizeProviderId, w as XIAOMI_DEFAULT_MODEL_ID, z as TOGETHER_MODEL_CATALOG, zt as resolvePowPowAgentDir } from "./model-selection-DAT49TVG.js";
...
const resolveAuthAgentDir = (agentDir) => agentDir ?? resolvePowPowAgentDir();
...
async function setMistralApiKey(key, agentDir) {
	upsertAuthProfile({
...
async function setKilocodeApiKey(key, agentDir) {
	upsertAuthProfile({
...
//#endregion
export { ZAI_DEFAULT_MODEL_REF as $, applyTogetherConfig as A, applyLitellmConfig as B, applyMoonshotProviderConfigCn as C, MOONSHOT_DEFAULT_MODEL_REF as Ct, applyQianfanProviderConfig as D, ZAI_CODING_CN_BASE_URL as Dt, applyQianfanConfig as E, ZAI_CN_BASE_URL as Et, applyXaiProviderConfig as F, applyVercelAiGatewayProviderConfig as G, applyCloudflareAiGatewayConfig as H, applyXiaomiConfig as I, LITELLM_DEFAULT_MODEL_REF as J, applyAgentDefaultModelPrimary as K, applyXiaomiProviderConfig as L, applyVeniceConfig as M, applyVeniceProviderConfig as N, applySyntheticConfig as O, ZAI_CODING_GLOBAL_BASE_URL as Ot, applyXaiConfig as P, XIAOMI_DEFAULT_MODEL_REF as Q, applyZaiConfig as R, applyMoonshotProviderConfig as S, MISTRAL_DEFAULT_MODEL_REF as St, applyOpenrouterProviderConfig as T, XAI_DEFAULT_MODEL_REF as Tt, applyCloudflareAiGatewayProviderConfig as U, applyLitellmProviderConfig as V, applyVercelAiGatewayConfig as W, TOGETHER_DEFAULT_MODEL_REF as X, OPENROUTER_DEFAULT_MODEL_REF as Y, VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF as Z, applyKimiCodeProviderConfig as _, setXaiApiKey as _t, applyMinimaxApiConfig as a, setKimiCodingApiKey as at, applyMoonshotConfig as b, writeOAuthCredentials as bt, applyMinimaxApiProviderConfigCn as c, setMistralApiKey as ct, applyAuthProfileConfig as d, setOpenrouterApiKey as dt, setAnthropicApiKey as et, applyHuggingfaceConfig as f, setQianfanApiKey as ft, applyKimiCodeConfig as g, setVercelAiGatewayApiKey as gt, applyKilocodeProviderConfig as h, setVeniceApiKey as ht, applyOpencodeZenProviderConfig as i, setKilocodeApiKey as it, applyTogetherProviderConfig as j, applySyntheticProviderConfig as k, ZAI_GLOBAL_BASE_URL as kt, applyMinimaxConfig as l, setMoonshotApiKey as lt, applyKilocodeConfig as m, setTogetherApiKey as mt, validateAnthropicSetupToken as n, setGeminiApiKey as nt, applyMinimaxApiConfigCn as o, setLitellmApiKey as ot, applyHuggingfaceProviderConfig as p, setSyntheticApiKey as pt, HUGGINGFACE_DEFAULT_MODEL_REF as q, applyOpencodeZenConfig as r, setHuggingfaceApiKey as rt, applyMinimaxApiProviderConfig as s, setMinimaxApiKey as st, buildTokenProfileId as t, setCloudflareAiGatewayConfig as tt, applyMinimaxProviderConfig as u, setOpencodeZenApiKey as ut, applyMistralConfig as v, setXiaomiApiKey as vt, applyOpenrouterConfig as w, QIANFAN_DEFAULT_MODEL_REF as wt, applyMoonshotConfigCn as x, KIMI_CODING_MODEL_REF as xt, applyMistralProviderConfig as y, setZaiApiKey as yt, applyZaiProviderConfig as z };