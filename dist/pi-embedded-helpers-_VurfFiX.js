import { d as resolveSessionAgentId, r as resolveAgentConfig } from "./agent-scope-rrgzCI7i.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-T4GVdxf1.js";
import { K as truncateUtf16Safe, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-COVUh7Yl.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-YGVrIVO5.js";
import { _ as runExec, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DqldSWWG.js";
import { n as formatCliCommand } from "./env-LAtE_PJh.js";
import { t as parseBooleanValue } from "./boolean-M-esQJt6.js";
import { t as generateSecureToken } from "./secure-random-xpZo1jCG.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-Dvd5i2nB.js";
import { _ as getBlockedNetworkModeReason, n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-x2H1-MTw.js";
import { A as resolveWritablePathWithinRoot, B as DEFAULT_POWPOW_BROWSER_PROFILE_NAME, C as stopChromeExtensionRelayServer, D as DEFAULT_UPLOAD_DIR, E as DEFAULT_TRACE_DIR, F as DEFAULT_AI_SNAPSHOT_MAX_CHARS, I as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, L as DEFAULT_BROWSER_EVALUATE_ENABLED, N as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, O as resolveExistingPathsWithinRoot, P as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, R as DEFAULT_POWPOW_BROWSER_COLOR, S as ensureChromeExtensionRelayServer, T as DEFAULT_DOWNLOAD_DIR, _ as appendCdpPath, a as resolvePowPowUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as withBrowserNavigationPolicy, h as assertBrowserNavigationResultAllowed, i as launchPowPowChrome, j as isLoopbackHost, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopPowPowChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchJson, y as fetchOk, z as DEFAULT_POWPOW_BROWSER_ENABLED } from "./chrome-DNmCcQ7R.js";
import { t as SsrFBlockedError } from "./ssrf-CoiLWsBO.js";
import { a as syncSkillsToWorkspace, f as PATH_ALIAS_POLICIES, g as sanitizeEnvVars, l as resolveSandboxInputPath, p as assertNoPathAliasEscape, u as resolveSandboxPath } from "./skills-DEKqQdxA.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-CDsFF_uo.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-CGiTyM5w.js";
import { B as resolveAgentMainSessionKey, G as acquireSessionWriteLock, z as canonicalizeMainSessionAlias } from "./sessions-CHe4lLyX.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-CcUb1sKD.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CIgrU8Mk.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CIgrU8Mk.js")).closePlaywrightBrowserConnection();
		} catch {}
