...
import { C as sleep, S as shortenHomePath, t as CONFIG_DIR, x as shortenHomeInString, y as resolveUserPath } from "./utils-C9Yd70Dr.js";
import { E as ensureAgentWorkspace, N as resolveAgentModelPrimaryValue, _ as DEFAULT_AGENT_WORKSPACE_DIR } from "./agent-scope-Coqt3COl.js";
...
import { A as isAvatarImageDataUrl, P as looksLikeAvatarPath, bt as isSafeExecutableValue, k as isAvatarHttpUrl } from "./config-ClR1jZcN.js";
import { r as VERSION } from "./env-vars-C_dl05a-.js";
import { n as pickPrimaryTailnetIPv4 } from "./tailnet-BNQgd2Nt.js";
import { l as pickPrimaryLanIPv4, s as isValidIPv4 } from "./ws-Bp1n_Uxk.js";
...
import { r as stylePromptTitle } from "./prompt-style-DP-Eq7qJ.js";
...
function formatControlUiSshHint(params) {
	...
	return [
		...
		authedUrl,
		"Docs:",
		"https://docs.PowPow.ai/gateway/remote",
		"https://docs.PowPow.ai/web/control-ui"
	].filter(Boolean).join("\n");
}
