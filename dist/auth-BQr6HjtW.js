...
import { a as isTrustedProxyAddress, l as resolveClientIp, n as isLoopbackAddress, t as isLocalishHost } from "./net-CliLiAjH.js";
import { n as resolveGatewayCredentialsFromValues } from "./credentials-DAkLWBAC.js";
import { c as readTailscaleWhoisIdentity } from "./tailscale-Mny9GO9e.js";
...
function assertGatewayAuthConfigured(auth) {
	if (auth.mode === "token" && !auth.token) {
		...
		throw new Error("gateway auth mode is token, but no token was configured (set gateway.auth.token or POWPOW_GATEWAY_TOKEN)");
	}
