...
import { _ as expandHomePrefix } from "./paths-Qu8BKDZT.js";
import { M as logVerbose, O as danger, t as CONFIG_DIR } from "./utils-C9Yd70Dr.js";
import { t as createSubsystemLogger } from "./subsystem-A8uKC1In.js";
import { t as isTruthyEnvValue } from "./env-BF71IqS7.js";
import { Tt as resolveTelegramPreviewStreamMode, i as loadConfig, l as writeConfigFile, s as readConfigFileSnapshotForWrite } from "./config-ClR1jZcN.js";
import { n as redactSensitiveText } from "./redact-DeH01ocq.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-Adli4uDW.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-DDebYeLI.js";
import { d as resolveTelegramAccount } from "./plugins-rCyIPzMG.js";
import { i as readChannelAllowFromStore } from "./pairing-store-BSzGxPBw.js";
import { t as resolveFetch } from "./fetch-D3h8BpE_.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-iuOnj7Cl.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-BIBAnr1T.js";
import { t as renderMarkdownWithMarkers } from "./render-C1H8wE-4.js";
import { n as normalizePollInput } from "./polls-PiwufXwX.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-DFMOrq2l.js";
import { n as isWSL2Sync } from "./wsl-BpqdBIpz.js";
import { t as makeProxyFetch } from "./proxy-BKYeJKIM.js";
...
//#endregion
export { resolveTelegramTargetChatType as $, describeReplyTarget as A, resolveTelegramThreadSpec as B, buildSenderLabel as C, buildTelegramParentPeer as D, buildTelegramGroupPeerId as E, resolveTelegramForumThreadId as F, firstDefined as G, normalizeAllowFrom as H, resolveTelegramGroupAllowFromContext as I, formatLocationText as J, isSenderIdAllowed as K, resolveTelegramMediaPlaceholder as L, extractTelegramLocation as M, hasBotMention as N, buildTelegramThreadParams as O, normalizeForwardedContext as P, parseTelegramTarget as Q, resolveTelegramReplyId as R, buildGroupLabel as S, buildTelegramGroupFrom as T, normalizeAllowFromWithStore as U, isSenderAllowed as V, resolveSenderAllowMatch as W, withTelegramApiErrorLogging as X, toLocationContext as Y, isVoiceCompatibleAudio as Z, markdownToTelegramHtml as _, reactMessageTelegram as a, resolveTelegramFetch as b, sendStickerTelegram as c, loadCronStore as d, resolveCronStorePath as f, markdownToTelegramChunks as g, isRecoverableTelegramNetworkError as h, editMessageTelegram as i, expandTextLinks as j, buildTypingThreadParams as k, send_exports as l, wasSentByBot as m, createForumTopicTelegram as n, sendMessageTelegram as o, saveCronStore as p, mergeAllowFromSources as q, deleteMessageTelegram as r, sendPollTelegram as s, buildInlineKeyboard as t, resolveTelegramVoiceSend as u, renderTelegramHtmlText as v, buildSenderName as w, splitTelegramCaption as x, wrapFileReferencesInHtml as y, resolveTelegramStreamMode as z };