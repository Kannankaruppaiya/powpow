...
import { H as resolveUserPath, Y as truncateUtf16Safe, c as CHANNEL_IDS, i as defaultRuntime, t as createSubsystemLogger } from "./subsystem-s7bDItS2.js";
import { n as loadConfig, o as writeConfigFile, t as createConfigIO, z as getBlockedNetworkModeReason } from "./config-CJwtnumZ.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-C8CwhlHn.js";
import { D as runExec, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-nFO5sKxo.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors--0EX9WJt.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-C1baxN0I.js";
import { t as SsrFBlockedError } from "./ssrf-D7nGqg1W.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-Cmv2Jubx.js";
import { _ as safeEqualSecret, a as syncSkillsToWorkspace, f as PATH_ALIAS_POLICIES, g as sanitizeEnvVars, l as resolveSandboxInputPath, p as assertNoPathAliasEscape, u as resolveSandboxPath } from "./skills-C9brHyHK.js";
...
import { A as acquireSessionWriteLock, H as resolveAgentMainSessionKey, V as canonicalizeMainSessionAlias } from "./sessions-CBtgUEpd.js";
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-W4y68mbT.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-H9O6yUu4.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-H9O6yUu4.js")).closePlaywrightBrowserConnection();
		} catch {}
