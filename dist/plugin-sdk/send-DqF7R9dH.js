...
import { a as resolveOAuthDir, c as expandHomePrefix, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-Biw6RtsH.js";
import { S as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-Bi68A-mi.js";
import { t as resolveFetch } from "./fetch-CrtQKsjS.js";
import { $ as logVerbose, O as CONFIG_DIR, U as safeParseJson, Z as danger, t as createSubsystemLogger } from "./subsystem-BBPkQl8F.js";
import { i as readConfigFileSnapshotForWrite, kt as resolveTelegramPreviewStreamMode, n as loadConfig, o as writeConfigFile } from "./config-Beao1DYH.js";
import { r as isTruthyEnvValue } from "./command-format-KJDDAM2E.js";
import { W as withFileLock$1 } from "./model-selection-CYqXFRmu.js";
import { t as redactSensitiveText } from "./redact-WaOJt0Qq.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-BjJdLum7.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-DFIm0KNg.js";
import { n as normalizePollInput } from "./polls-B-RrIekF.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-B6WDOaEz.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-BLaXyoxv.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-DzmZ80K9.js";
import { t as renderMarkdownWithMarkers } from "./render-DzUFCfck.js";
import { t as makeProxyFetch } from "./proxy-Cbu5iJdR.js";
...
async function readChannelAllowFromStore(channel, env = process.env, accountId) {
	...
	if (!normalizedAccountId) return await readAllowFromStateForPath(channel, resolveAllowFromPath(channel, env));
	if (!shouldIncludeLegacyAllowFromEntries(normalizedAccountId)) return await readNonDefaultAccountAllowFrom({
		channel,
		env,
...
function readChannelAllowFromStoreSync(channel, env = process.env, accountId) {
	const normalizedAccountId = accountId?.trim().toLowerCase() ?? "";
	if (!normalizedAccountId) return readAllowFromStateForPathSync(channel, resolveAllowFromPath(channel, env));
	if (!shouldIncludeLegacyAllowFromEntries(normalizedAccountId)) return readNonDefaultAccountAllowFromSync({
		channel,
		env,
		accountId: normalizedAccountId
	});
	const scopedEntries = readAllowFromStateForPathSync(channel, resolveAllowFromPath(channel, env, accountId));
...
const DIAGNOSTICS_ENV = "POWPOW_DIAGNOSTICS";
...
const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "POWPOW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "POWPOW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_DNS_RESULT_ORDER_ENV = "POWPOW_TELEGRAM_DNS_RESULT_ORDER";
let wsl2SyncCache;
...
*
* Priority:
* 1. Environment variable POWPOW_TELEGRAM_DNS_RESULT_ORDER
...
//#endregion
export { removeChannelAllowFromStoreEntry as $, hasBotMention as A, normalizeAllowFromWithStore as B, buildTelegramGroupPeerId as C, describeReplyTarget as D, buildTypingThreadParams as E, resolveTelegramReplyId as F, withTelegramApiErrorLogging as G, firstDefined as H, resolveTelegramStreamMode as I, parseTelegramTarget as J, isVoiceCompatibleAudio as K, resolveTelegramThreadSpec as L, resolveTelegramForumThreadId as M, resolveTelegramGroupAllowFromContext as N, expandTextLinks as O, resolveTelegramMediaPlaceholder as P, readChannelAllowFromStoreSync as Q, isSenderAllowed as R, buildTelegramGroupFrom as S, buildTelegramThreadParams as T, isSenderIdAllowed as U, resolveSenderAllowMatch as V, mergeAllowFromSources as W, addChannelAllowFromStoreEntry as X, resolveTelegramTargetChatType as Y, readChannelAllowFromStore as Z, resolveTelegramFetch as _, reactMessageTelegram as a, isWSL2Sync as at, buildSenderLabel as b, sendStickerTelegram as c, readJsonFileWithFallback as ct, wasSentByBot as d, upsertChannelPairingRequest as et, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, toLocationContext as it, normalizeForwardedContext as j, extractTelegramLocation as k, send_exports as l, writeJsonFileAtomically as lt, markdownToTelegramHtml as m, createForumTopicTelegram as n, listPairingChannels as nt, sendMessageTelegram as o, isWSLEnv as ot, markdownToTelegramChunks as p, normalizeTelegramLookupTarget as q, deleteMessageTelegram as r, formatLocationText as rt, sendPollTelegram as s, isWSLSync as st, buildInlineKeyboard as t, getPairingAdapter as tt, resolveTelegramVoiceSend as u, splitTelegramCaption as v, buildTelegramParentPeer as w, buildSenderName as x, buildGroupLabel as y, normalizeAllowFrom as z };