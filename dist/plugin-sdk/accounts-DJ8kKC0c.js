...
import { a as resolveOAuthDir } from "./paths-Biw6RtsH.js";
import { t as resolveAccountEntry } from "./account-lookup-B-58l5Qb.js";
import { H as resolveUserPath, L as jidToE164, Q as info, ct as getChildLogger, i as defaultRuntime, rt as success } from "./subsystem-BBPkQl8F.js";
...
async function pickWebChannel(pref, authDir = resolveDefaultWebAuthDir()) {
	...
	if (!await webAuthExists(authDir)) throw new Error(`No WhatsApp Web session found. Run \`${formatCliCommand("PowPow channels login --channel whatsapp --verbose")}\` to link.`);
	return choice;
}
