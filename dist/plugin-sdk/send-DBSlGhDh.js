...
import { B as parseTargetPrefixes, F as resolveDiscordAccount, I as normalizeDiscordToken, L as buildMessagingTarget, R as ensureTargetId, V as requireTargetKind, z as parseTargetMention } from "./plugins-Bi68A-mi.js";
import { t as resolveFetch } from "./fetch-CrtQKsjS.js";
import { mt as resolvePreferredPowPowTmpDir } from "./subsystem-BBPkQl8F.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-CCbv_iBy.js";
import { n as loadConfig } from "./config-Beao1DYH.js";
import { n as recordChannelActivity, r as createDiscordRetryRunner } from "./channel-activity-DFIm0KNg.js";
import { n as normalizePollInput, t as normalizePollDurationHours } from "./polls-B-RrIekF.js";
import { _ as maxBytesForKind, l as extensionForMime } from "./image-ops-B6WDOaEz.js";
import { a as loadWebMedia, o as loadWebMediaRaw } from "./ir-BLaXyoxv.js";
import { c as resolveChunkMode, i as chunkMarkdownTextWithMode } from "./chunk-Cx8UzZ-K.js";
...
//#endregion
export { fetchChannelPermissionsDiscord as $, unpinMessageDiscord as A, fetchDiscord as At, listScheduledEventsDiscord as B, editMessageDiscord as C, resolveTimestampMs as Ct, pinMessageDiscord as D, resolveChannelEntryMatch as Dt, listThreadsDiscord as E, normalizeChannelSlug as Et, fetchMemberInfoDiscord as F, uploadStickerDiscord as G, timeoutMemberDiscord as H, fetchRoleInfoDiscord as I, editChannelDiscord as J, createChannelDiscord as K, fetchVoiceStatusDiscord as L, banMemberDiscord as M, createScheduledEventDiscord as N, readMessagesDiscord as O, resolveChannelEntryMatchWithFallback as Ot, fetchChannelInfoDiscord as P, stripUndefinedFields as Q, kickMemberDiscord as R, deleteMessageDiscord as S, resolveDiscordSystemLocation as St, listPinsDiscord as T, buildChannelKeyCandidates as Tt, listGuildEmojisDiscord as U, removeRoleDiscord as V, uploadEmojiDiscord as W, removeChannelPermissionDiscord as X, moveChannelDiscord as Y, setChannelPermissionDiscord as Z, sendPollDiscord as _, resolveDiscordShouldRequireMention as _t, removeReactionDiscord as a, resolveDiscordChannelId as at, sendWebhookMessageDiscord as b, formatDiscordReactionEmoji as bt, formatDiscordComponentEventText as c, allowListMatches as ct, parseDiscordModalCustomId as d, normalizeDiscordSlug as dt, hasAnyGuildPermissionDiscord as et, parseDiscordModalCustomIdForCarbon as f, resolveDiscordAllowListMatch as ft, sendMessageDiscord as g, resolveDiscordOwnerAllowFrom as gt, resolveDiscordModalEntry as h, resolveDiscordMemberAccessState as ht, removeOwnReactionsDiscord as i, parseDiscordTarget as it, addRoleDiscord as j, searchMessagesDiscord as k, resolveNestedAllowlistDecision as kt, parseDiscordComponentCustomId as l, isDiscordGroupAllowedByPolicy as lt, resolveDiscordComponentEntry as m, resolveDiscordGuildEntry as mt, fetchReactionsDiscord as n, createDiscordClient as nt, sendDiscordComponentMessage as o, listDiscordDirectoryGroupsLive as ot, readDiscordComponentSpec as p, resolveDiscordChannelConfigWithFallback as pt, deleteChannelDiscord as q, reactMessageDiscord as r, createDiscordRestClient as rt, createDiscordFormModal as s, listDiscordDirectoryPeersLive as st, send_exports as t, chunkDiscordTextWithMode as tt, parseDiscordComponentCustomIdForCarbon as u, normalizeDiscordAllowList as ut, sendStickerDiscord as v, resolveGroupDmAllow as vt, fetchMessageDiscord as w, applyChannelMatchMeta as wt, createThreadDiscord as x, formatDiscordUserTag as xt, sendVoiceMessageDiscord as y, shouldEmitDiscordReactionNotification as yt, listGuildChannelsDiscord as z };