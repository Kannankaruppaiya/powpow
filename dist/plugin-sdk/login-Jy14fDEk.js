...
import { i as resolveWhatsAppAccount, l as logoutWeb } from "./accounts-DxYZsuli.js";
import { Q as info, Z as danger, i as defaultRuntime, rt as success } from "./subsystem-s7bDItS2.js";
import { n as loadConfig } from "./config-CJwtnumZ.js";
import { t as formatCliCommand } from "./command-format-C8CwhlHn.js";
import { j as logInfo } from "./agent-scope-nFO5sKxo.js";
import { i as waitForWaConnection, n as formatError, t as createWaSocket } from "./session-_Alvzgh7.js";
...
async function loginWeb(verbose, waitForConnection, runtime = defaultRuntime, accountId) {
	...
	try {
		...
		if (code === DisconnectReason.loggedOut) {
			...
			console.error(danger(`WhatsApp reported the session is logged out. Cleared cached web session; please rerun ${formatCliCommand("PowPow channels login")} and scan the QR again.`));
