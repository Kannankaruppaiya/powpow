import { O as CONFIG_DIR, mt as resolvePreferredPowPowTmpDir, t as createSubsystemLogger } from "./subsystem-BBPkQl8F.js";
import { n as loadConfig } from "./config-Beao1DYH.js";
import { i as isErrno } from "./errors-BjJdLum7.js";
import { n as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-B8Ak70Tm.js";
import { n as isPathInside, t as isNotFoundPathError } from "./path-guards-D-LNoA8B.js";
import { l as isLoopbackIpAddress, s as resolvePinnedHostnameWithPolicy } from "./ssrf-D7nGqg1W.js";
...
//#endregion
export { DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH as A, rawDataToString as B, stopChromeExtensionRelayServer as C, resolveExistingPathsWithinRoot as D, DEFAULT_UPLOAD_DIR as E, DEFAULT_POWPOW_BROWSER_COLOR as F, DEFAULT_POWPOW_BROWSER_ENABLED as I, DEFAULT_POWPOW_BROWSER_PROFILE_NAME as L, DEFAULT_AI_SNAPSHOT_MAX_CHARS as M, DEFAULT_BROWSER_DEFAULT_PROFILE_NAME as N, resolveStrictExistingPathsWithinRoot as O, DEFAULT_BROWSER_EVALUATE_ENABLED as P, isLoopbackHost as R, ensureChromeExtensionRelayServer as S, DEFAULT_TRACE_DIR as T, appendCdpPath as _, resolvePowPowUserDataDir as a, getHeadersWithAuth as b, captureScreenshot as c, normalizeCdpWsUrl as d, snapshotAria as f, withBrowserNavigationPolicy as g, assertBrowserNavigationResultAllowed as h, launchPowPowChrome as i, DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS as j, resolveWritablePathWithinRoot as k, createTargetViaCdp as l, assertBrowserNavigationAllowed as m, isChromeCdpReady as n, stopPowPowChrome as o, InvalidBrowserNavigationUrlError as p, isChromeReachable as r, resolveBrowserExecutableForPlatform as s, getChromeWebSocketUrl as t, formatAriaSnapshot as u, fetchJson as v, DEFAULT_DOWNLOAD_DIR as w, withCdpSocket as x, fetchOk as y, isSecureWebSocketUrl as z };