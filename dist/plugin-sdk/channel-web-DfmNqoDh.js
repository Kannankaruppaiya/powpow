import { a as buildGroupHistoryKey, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey, s as normalizeAgentId } from "./session-key-C7qWg3SH.js";
import { i as resolveWhatsAppAccount, p as readWebSelfId, s as getWebAuthAgeMs } from "./accounts-DxYZsuli.js";
import { At as resolveDefaultGroupPolicy, C as formatDurationPrecise, K as shouldAckReactionForWhatsApp, Nt as warnMissingProviderGroupPolicyFallbackOnce, Q as buildHistoryContextFromEntries, Z as DEFAULT_GROUP_HISTORY_LIMIT, at as buildMentionRegexes, c as computeBackoff, d as dispatchReplyWithBufferedBlockDispatcher, g as shouldComputeCommandAuthorized, h as hasControlCommand, ht as createDedupeCache, it as recordPendingHistoryEntryIfEnabled, jt as resolveOpenProviderRuntimeGroupPolicy, l as sleepWithAbort, m as resolveInboundDebounceMs, n as normalizeGroupActivation, ot as normalizeMentionText, p as createInboundDebouncer, q as resolveMentionGating, r as parseActivationCommand, t as getReplyFromConfig, u as buildPairingReply, w as enqueueSystemEvent, xt as resolveEnvelopeFormatOptions, yt as formatInboundEnvelope } from "./reply-iviBe-qB.js";
import { $ as logVerbose, I as isSelfChatMode, J as toWhatsappJid, K as sleep, L as jidToE164, R as normalizeE164, V as resolveJidToE164, ct as getChildLogger, i as defaultRuntime, k as clamp, m as normalizeChatChannelId, nt as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-s7bDItS2.js";
import { n as loadConfig } from "./config-CJwtnumZ.js";
import { t as formatCliCommand } from "./command-format-C8CwhlHn.js";
import { M as resolveChannelGroupRequireMention, j as resolveChannelGroupPolicy } from "./dock-Xj0fMACU.js";
import { n as recordChannelActivity } from "./channel-activity-Cq5YXJ2w.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-BkU_uXsG.js";
import { a as loadWebMedia } from "./ir-Df16PE0C.js";
import { c as resolveChunkMode, i as chunkMarkdownTextWithMode, l as resolveTextChunkLimit } from "./chunk-C4xahrCG.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-CSgaWdPy.js";
import { t as convertMarkdownTables } from "./tables-D-1CX2bV.js";
import { Q as readChannelAllowFromStoreSync, Z as readChannelAllowFromStore, et as upsertChannelPairingRequest, it as toLocationContext, rt as formatLocationText } from "./send-ig36Y_WX.js";
import { f as registerUnhandledRejectionHandler } from "./runner-9DhjdzX4.js";
import { l as resolveIdentityNamePrefix, n as createReplyPrefixOptions, u as resolveMessagePrefix } from "./reply-prefix-DonNj0YH.js";
import { K as resolveGroupSessionKey, c as readSessionUpdatedAt, l as recordSessionMetaFromInbound, s as loadSessionStore, u as updateLastRoute } from "./sessions-CBtgUEpd.js";
import { l as resolveStorePath } from "./paths-BWCcyYYG.js";
import { i as saveMediaBuffer } from "./store-W4y68mbT.js";
import { t as finalizeInboundContext } from "./inbound-context-H04QMNo0.js";
import { n as resolveAgentRoute, t as buildAgentSessionKey } from "./resolve-route-DEXp_sip.js";
import { r as setActiveWebListener } from "./active-listener-BppkfXbQ.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp } from "./outbound-H3WaJCOG.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-_Alvzgh7.js";
...
async function checkInboundAccessControl(params) {
	...
	const storeAllowFrom = dmPolicy === "allowlist" ? [] : await readChannelAllowFromStore("whatsapp", process.env, account.accountId).catch(() => []);
...
async function processMessage(params) {
	...
	const responsePrefix = prefixOptions.responsePrefix ?? (configuredResponsePrefix === void 0 && isSelfChat ? resolveIdentityNamePrefix(params.cfg, params.route.agentId) ?? "[powpow]" : void 0);
...
async function monitorWebChannel(verbose, listenerFactory = monitorWebInbox, keepAlive = true, replyResolver = getReplyFromConfig, runtime = defaultRuntime, abortSignal, tuning = {}) {
	...
	while (true) {
		...
		if (loggedOut) {
			runtime.error(`WhatsApp session logged out. Run \`${formatCliCommand("PowPow channels login --channel web")}\` to relink.`);
			await closeListener();
			break;
		}
		if (isNonRetryableWebCloseStatus(statusCode)) {
			...
			runtime.error(`WhatsApp Web connection closed (status ${statusCode}: session conflict). Resolve conflicting WhatsApp Web sessions, then relink with \`${formatCliCommand("PowPow channels login --channel web")}\`. Stopping web monitoring.`);
			await closeListener();
			break;
		}
		reconnectAttempts += 1;
