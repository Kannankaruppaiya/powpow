...
import { $ as logVerbose, mt as resolvePreferredPowPowTmpDir, nt as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-BBPkQl8F.js";
import { S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, n as loadConfig, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-Beao1DYH.js";
import { E as resolveApiKeyForProvider, H as resolvePowPowAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-CYqXFRmu.js";
import { D as runExec, F as resolveAgentModelPrimaryValue, P as resolveAgentModelFallbackValues } from "./agent-scope-D2mtbkzb.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-B6WDOaEz.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-Cq9O_7KH.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-BhV_9vuS.js";
import { t as normalizeChatType } from "./chat-type-CEMQNtWX.js";
import { C as ensurePowPowModelsJson, t as describeImageWithModel } from "./image-ClYDGNul.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DIp0I4yy.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-B3reDphO.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-BqwThwrH.js")).ensurePiAuthJsonFromAuthProfiles(resolvePowPowAgentDir());
