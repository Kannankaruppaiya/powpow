...
import { $ as logVerbose, mt as resolvePreferredPowPowTmpDir, nt as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-s7bDItS2.js";
import { S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, n as loadConfig, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-CJwtnumZ.js";
import { E as resolveApiKeyForProvider, H as resolvePowPowAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection--PywJcVq.js";
import { D as runExec, F as resolveAgentModelPrimaryValue, P as resolveAgentModelFallbackValues } from "./agent-scope-nFO5sKxo.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-C1baxN0I.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CfqNjBMW.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-BkU_uXsG.js";
import { t as normalizeChatType } from "./chat-type-CEMQNtWX.js";
import { C as ensurePowPowModelsJson, t as describeImageWithModel } from "./image-Iq-luJuj.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DQ1KuR78.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-DwGmqhd2.js")).ensurePiAuthJsonFromAuthProfiles(resolvePowPowAgentDir());
