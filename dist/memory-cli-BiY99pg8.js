...
import { L as colorize, N as setVerbose, R as isRich, b as shortenHomeInString, v as resolveUserPath, x as shortenHomePath, z as theme } from "./utils-BWJH7VRh.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-Ac0Vygcn.js";
import { T as parseDurationMs, i as loadConfig, mt as splitShellArgs } from "./config-B91e8u6L.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-Bb9K0Q_0.js";
import { t as formatDocsLink } from "./links-C00eySj4.js";
import { r as withManager } from "./cli-utils-DXfA5936.js";
import { t as formatHelpExamples } from "./help-format-DVoiHgO5.js";
import { n as withProgress, r as withProgressTotals } from "./progress-DF7PrFZS.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-SsxHtDdd.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-JprmBt9D.js").then((n) => n.t);
...
function registerMemoryCli(program) {
	const memory = program.command("memory").description("Search, inspect, and reindex memory files").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		["PowPow memory status", "Show index and provider status."],
		["PowPow memory index --force", "Force a full reindex."],
		["PowPow memory search --query \"deployment notes\"", "Search indexed memory entries."],
		["PowPow memory status --json", "Output machine-readable JSON."]
	])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/memory", "docs.PowPow.ai/cli/memory")}\n`);
