import { n as isDangerousHostEnvVarName, r as normalizeEnvVarKey, t as isDangerousHostEnvOverrideVarName } from "./host-env-security-IP2UsfGZ.js";
...
function resolveRuntimeServiceVersion(env = process.env, fallback = "dev") {
	return firstNonEmpty(env["POWPOW_VERSION"], env["POWPOW_SERVICE_VERSION"], env["npm_package_version"]) ?? fallback;
}
