import { a as resolveOAuthDir, c as expandHomePrefix, l as resolveEffectiveHomeDir, n as resolveConfigPath, u as resolveRequiredHomeDir } from "./paths-T4GVdxf1.js";
...
function isGatewayStartupEvent(event) {
	if (event.type !== "gateway" || event.action !== "startup") return false;
	const context = event.context;
...
const CHAT_CHANNEL_META = {
	telegram: {
		...
		selectionExtras: ["https://PowPow.ai"]
	},
	whatsapp: {
		id: "whatsapp",
		label: "WhatsApp",
...
//#endregion
export { shouldLogVerbose as $, escapeRegExp as A, safeParseJson as B, listPluginCommands as C, clampInt as D, clamp as E, normalizeE164 as F, toWhatsappJid as G, shortenHomePath as H, pathExists as I, danger as J, truncateUtf16Safe as K, resolveConfigDir as L, isRecord as M, isSelfChatMode as N, clampNumber as O, jidToE164 as P, setVerbose as Q, resolveJidToE164 as R, getPluginCommandSpecs as S, CONFIG_DIR as T, sleep as U, shortenHomeInString as V, sliceUtf16Safe as W, logVerbose as X, info as Y, logVerboseConsole as Z, setActivePluginRegistry as _, registerActiveProgressLine as a, getChildLogger as at, clearPluginCommands as b, CHAT_CHANNEL_ORDER as c, resolveNodeRequireFromMeta as ct, normalizeAnyChannelId as d, createInternalHookEvent as dt, success as et, normalizeChannelId as f, isAgentBootstrapEvent as ft, requireActivePluginRegistry as g, getActivePluginRegistryKey as h, clearActiveProgressLine as i, theme as it, formatTerminalLink as j, ensureDir as k, getChatChannelMeta as l, normalizeLogLevel as lt, getActivePluginRegistry as m, triggerInternalHook as mt, createNonExitingRuntime as n, colorize as nt, unregisterActiveProgressLine as o, getLogger as ot, normalizeChatChannelId as p, isGatewayStartupEvent as pt, isPlainObject as q, defaultRuntime as r, isRich as rt, CHANNEL_IDS as s, toPinoLikeLogger as st, createSubsystemLogger as t, warn as tt, listChatChannels as u, resolvePreferredPowPowTmpDir as ut, createPluginRegistry as v, matchPluginCommand as w, executePluginCommand as x, normalizePluginHttpPath as y, resolveUserPath as z };