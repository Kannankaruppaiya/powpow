...
import { O as info, R as isRich, c as escapeRegExp, z as theme } from "./utils-BWJH7VRh.js";
import { r as isTruthyEnvValue } from "./entry.js";
import { d as resolveDefaultAgentId, i as resolveAgentConfig, u as resolveAgentWorkspaceDir, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-Ac0Vygcn.js";
import { l as resolveAgentIdFromSessionKey, p as toAgentStoreSessionKey, s as normalizeAgentId } from "./session-key-DXmKFT2p.js";
import { T as parseDurationMs, i as loadConfig } from "./config-B91e8u6L.js";
import { Q as resolveAgentMainSessionKey, Z as canonicalizeMainSessionAlias, c as loadSessionStore, h as updateSessionStore, p as saveSessionStore } from "./sessions-DGKLiJDU.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./plugins-CPaMeorQ.js";
import { a as resolvePreferredAccountId, t as buildChannelAccountBindings } from "./bindings-B0Nfghiw.js";
import { $n as resolveUserTimezone, Cr as isHeartbeatContentEffectivelyEmpty, Dn as setHeartbeatWakeHandler, En as requestHeartbeatNow, On as resolveHeartbeatReasonKind, Q as getReplyFromConfig, Sr as DEFAULT_HEARTBEAT_EVERY, Tr as stripHeartbeatToken, br as CommandLane, dt as resolveHeartbeatDeliveryTarget, et as appendCronStyleCurrentTimeLine, ft as resolveHeartbeatSenderContext, hr as getQueueSize, wn as peekSystemEventEntries, wr as resolveHeartbeatPrompt$1, xr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS } from "./subagent-registry-DXZuSN83.js";
import { l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BB4B9o0x.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-Dy4jPY6_.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-JeXMO5S0.js";
import { t as deliverOutboundPayloads } from "./deliver-Dawegl6G.js";
import { i as hasErrnoCode, n as formatErrorMessage } from "./errors-BpyuHard.js";
import { o as resolveEffectiveMessagesConfig } from "./reply-prefix-BisA89Mu.js";
import { n as withProgress } from "./progress-DF7PrFZS.js";
import { a as resolveIndicatorType, n as emitHeartbeatEvent, o as resolveHeartbeatReplyPayload, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CIWasOfj.js";
...
const debugHealth = (...args) => {
	if (isTruthyEnvValue(process.env.POWPOW_DEBUG_HEALTH)) console.warn("[health:debug]", ...args);
};
...
async function healthCommand(opts, runtime) {
	...
	if (opts.json) runtime.log(JSON.stringify(summary, null, 2));
		...
		const debugEnabled = isTruthyEnvValue(process.env.POWPOW_DEBUG_HEALTH);
		const rich = isRich();
		if (opts.verbose) {
