...
import { Bt as discoverHuggingfaceModels, Ct as getCustomProviderApiKey, Dt as resolveEnvApiKey, E as resolvePowPowAgentDir, Ht as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, Kt as KILOCODE_DEFAULT_MODEL_REF, Vt as isHuggingfacePolicyLocked, W as resolveDefaultModelForAgent, _t as SYNTHETIC_DEFAULT_MODEL_REF, d as exchangeChutesCodeForTokens, f as generateChutesPkce, g as listProfilesForProvider, n as resolveAuthProfileOrder, p as parseOAuthCallbackInput, u as CHUTES_AUTHORIZE_ENDPOINT, ut as VENICE_DEFAULT_MODEL_REF, x as ensureAuthProfileStore, y as upsertAuthProfile } from "./auth-profiles-KPMal-k-.js";
import { A as resolveDefaultAgentWorkspaceDir, P as toAgentModelListLike, a as resolveAgentDir, d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-Ac0Vygcn.js";
import { r as isLoopbackHost } from "./net-CliLiAjH.js";
import { n as loadModelCatalog } from "./model-catalog-ExB4NYZv.js";
import { f as openUrl } from "./onboard-helpers-BNEaJ_0q.js";
import { t as enablePluginInConfig } from "./enable-Bup-tbnL.js";
import { $ as ZAI_DEFAULT_MODEL_REF, A as applyTogetherConfig, B as applyLitellmConfig, C as applyMoonshotProviderConfigCn, Ct as MOONSHOT_DEFAULT_MODEL_REF, D as applyQianfanProviderConfig, E as applyQianfanConfig, F as applyXaiProviderConfig, G as applyVercelAiGatewayProviderConfig, H as applyCloudflareAiGatewayConfig, I as applyXiaomiConfig, J as LITELLM_DEFAULT_MODEL_REF, K as applyAgentDefaultModelPrimary, L as applyXiaomiProviderConfig, M as applyVeniceConfig, N as applyVeniceProviderConfig, O as applySyntheticConfig, P as applyXaiConfig, Q as XIAOMI_DEFAULT_MODEL_REF, R as applyZaiConfig, S as applyMoonshotProviderConfig, St as MISTRAL_DEFAULT_MODEL_REF, T as applyOpenrouterProviderConfig, Tt as XAI_DEFAULT_MODEL_REF, U as applyCloudflareAiGatewayProviderConfig, V as applyLitellmProviderConfig, W as applyVercelAiGatewayConfig, X as TOGETHER_DEFAULT_MODEL_REF, Y as OPENROUTER_DEFAULT_MODEL_REF, Z as VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF, _ as applyKimiCodeProviderConfig, _t as setXaiApiKey, a as applyMinimaxApiConfig, at as setKimiCodingApiKey, b as applyMoonshotConfig, bt as writeOAuthCredentials, c as applyMinimaxApiProviderConfigCn, ct as setMistralApiKey, d as applyAuthProfileConfig, dt as setOpenrouterApiKey, et as setAnthropicApiKey, ft as setQianfanApiKey, g as applyKimiCodeConfig, gt as setVercelAiGatewayApiKey, h as applyKilocodeProviderConfig, ht as setVeniceApiKey, i as applyOpencodeZenProviderConfig, it as setKilocodeApiKey, j as applyTogetherProviderConfig, k as applySyntheticProviderConfig, l as applyMinimaxConfig, lt as setMoonshotApiKey, m as applyKilocodeConfig, mt as setTogetherApiKey, n as validateAnthropicSetupToken, nt as setGeminiApiKey, o as applyMinimaxApiConfigCn, ot as setLitellmApiKey, p as applyHuggingfaceProviderConfig, pt as setSyntheticApiKey, q as HUGGINGFACE_DEFAULT_MODEL_REF, r as applyOpencodeZenConfig, rt as setHuggingfaceApiKey, s as applyMinimaxApiProviderConfig, st as setMinimaxApiKey, t as buildTokenProfileId, tt as setCloudflareAiGatewayConfig, u as applyMinimaxProviderConfig, ut as setOpencodeZenApiKey, v as applyMistralConfig, vt as setXiaomiApiKey, w as applyOpenrouterConfig, wt as QIANFAN_DEFAULT_MODEL_REF, x as applyMoonshotConfigCn, xt as KIMI_CODING_MODEL_REF, y as applyMistralProviderConfig, yt as setZaiApiKey, z as applyZaiProviderConfig } from "./auth-token-xlDYHYGE.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-E8KJXle6.js";
import { a as detectZaiEndpoint, c as ensureModelAllowlistEntry, i as upsertSharedEnvVar, n as applyOpenAIConfig, o as GOOGLE_GEMINI_DEFAULT_MODEL, r as applyOpenAIProviderConfig, s as applyGoogleGeminiModelDefault, t as OPENAI_DEFAULT_MODEL } from "./openai-model-default-DDnPcYm4.js";
import { c as OPENAI_CODEX_DEFAULT_MODEL, l as applyOpenAICodexModelDefault, r as applyPrimaryModel, s as promptAndConfigureVllm } from "./model-picker-BEfZoi__.js";
...
async function applyAuthChoiceApiProviders(params) {
	...
	if (authChoice === "cloudflare-ai-gateway-api-key") {
		...
		let resolvedApiKey = "";
		if (accountId && gatewayId && optsApiKey) resolvedApiKey = optsApiKey;
...
async function applyAuthChoiceBytePlus(params) {
	...
	if (envKey) {
		if (await params.prompter.confirm({
			...
			if (!process.env.BYTEPLUS_API_KEY) process.env.BYTEPLUS_API_KEY = envKey.apiKey;
			await params.prompter.note(`Copied BYTEPLUS_API_KEY to ${result.path} for launchd compatibility.`, "BytePlus API key");
			return {
				config: applyPrimaryModel(params.config, BYTEPLUS_DEFAULT_MODEL),
				agentModelOverride: BYTEPLUS_DEFAULT_MODEL
			};
		}
	}
	let key;
	if (params.opts?.byteplusApiKey) key = params.opts.byteplusApiKey;
...
async function applyAuthChoicePluginProvider(params, options) {
	...
	const agentDir = params.agentDir ?? (agentId === defaultAgentId ? resolvePowPowAgentDir() : resolveAgentDir(nextConfig, agentId));
		...
		const server = createServer((req, res) => {
			try {
				...
				res.end([
					...
					"<p>You can close this window and return to PowPow.</p></body></html>"
				].join(""));
...
async function loginOpenAICodexOAuth(params) {
	...
	try {
		...
		await prompter.note("Trouble with OAuth? See https://docs.PowPow.ai/start/faq", "OAuth help");
		throw err;
	}
}
...
async function applyAuthChoiceVolcengine(params) {
	...
	if (envKey) {
		if (await params.prompter.confirm({
			...
			if (!process.env.VOLCANO_ENGINE_API_KEY) process.env.VOLCANO_ENGINE_API_KEY = envKey.apiKey;
			await params.prompter.note(`Copied VOLCANO_ENGINE_API_KEY to ${result.path} for launchd compatibility.`, "Volcano Engine API Key");
			return {
				config: applyPrimaryModel(params.config, VOLCENGINE_DEFAULT_MODEL),
				agentModelOverride: VOLCENGINE_DEFAULT_MODEL
			};
		}
	}
	let key;
	if (params.opts?.volcengineApiKey) key = params.opts.volcengineApiKey;
	else key = await params.prompter.text({
