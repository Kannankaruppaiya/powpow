...
import { E as resolvePowPowAgentDir } from "./auth-profiles-KPMal-k-.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-Do3xMEtM.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CQsSYJmZ.js").then((n) => n.n)).ensurePiAuthJsonFromAuthProfiles(resolvePowPowAgentDir());
