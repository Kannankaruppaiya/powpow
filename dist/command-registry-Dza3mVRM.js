...
import { i as registerSubCliCommands, o as removeCommandByName, s as reparseProgramFromActionArgs } from "./register.subclis-DzdFJd1I.js";
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-Cw8vLMlj.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-DQ5V3jVd.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
	...
	},
	{
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-DcNhwXh_.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
