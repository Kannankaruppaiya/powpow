import { g as resolveStateDir, i as isNixMode, l as resolveGatewayLockDir, o as resolveConfigPath, r as STATE_DIR, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-BJtes5yu.js";
import { A as createEmptyPluginRegistry, B as registerInternalHook, E as getActivePluginRegistry, R as clearInternalHooks, V as triggerInternalHook, _ as CHANNEL_IDS, a as setConsoleSubsystemFilter, f as defaultRuntime, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger, z as createInternalHookEvent } from "./subsystem-DXlyH4H4.js";
import { B as getChildLogger, E as isPlainObject, H as getResolvedLoggerSettings, L as colorize, N as setVerbose, R as isRich, T as truncateUtf16Safe, V as getLogger, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath, z as theme } from "./utils-BWJH7VRh.js";
import "./boolean-YY6K2DFz.js";
import { i as logAcceptedEnvOption, r as isTruthyEnvValue } from "./entry.js";
import { A as buildAllowedModelSet, At as normalizeSecretInput, G as resolveHooksGmailModel, I as isCliProvider, J as resolveSubagentConfiguredModelSelection, Jt as DEFAULT_MODEL, P as getModelRefStatus, U as resolveConfiguredModelRef, V as resolveAllowedModelRef, W as resolveDefaultModelForAgent, X as resolveThinkingDefault, Yt as DEFAULT_PROVIDER, k as isPidAlive, qt as DEFAULT_CONTEXT_TOKENS } from "./auth-profiles-KPMal-k-.js";
import { t as formatCliCommand } from "./command-format-DRH7uGKn.js";
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-Ac0Vygcn.js";
import { C as isSubagentSessionKey, c as normalizeMainKey, f as toAgentRequestSessionKey, h as normalizeAccountId$1, l as resolveAgentIdFromSessionKey, m as DEFAULT_ACCOUNT_ID, o as classifySessionKeyShape, p as toAgentStoreSessionKey, r as buildAgentMainSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID, w as parseAgentSessionKey, x as isCronRunSessionKey } from "./session-key-DXmKFT2p.js";
import { r as matchesSkillFilter, t as resolvePowPowPackageRoot } from "./powpow-root-DNPuMfcb.js";
import { i as logDebug, n as runExec, s as logWarn, t as runCommandWithTimeout } from "./exec-Du-v-jcI.js";
...
import { d as hasBinary } from "./frontmatter-B7nss1o8.js";
import { r as isPathInsideWithRealpath } from "./scan-paths-CYzbUHyr.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-D7zMUUWl.js";
import { n as isPathInside, t as isNotFoundPathError } from "./path-guards-UU2pe5bX.js";
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-C9O9KUb3.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-TqUhMg2L.js";
import { A as isAvatarImageDataUrl, At as resolveAgentMaxConcurrent, D as AVATAR_MAX_BYTES, E as parseByteSize, Ot as buildTalkConfigResponse, P as looksLikeAvatarPath, T as parseDurationMs, a as parseConfigJson5, c as resolveConfigSnapshotHash, d as PowPowSchema, i as loadConfig, jt as resolveSubagentMaxConcurrent, k as isAvatarHttpUrl, l as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as readConfigFileSnapshotForWrite, u as validateConfigObjectWithPlugins, vt as applyMergePatch, yt as applyLegacyMigrations } from "./config-B91e8u6L.js";
import { i as resolveRuntimeServiceVersion, r as VERSION } from "./env-vars-D53NnL-N.js";
import "./dock-DaMhmHr_.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-DYK7E7vt.js";
import { $ as resolveExplicitAgentSessionKey, A as readSessionMessages, B as cleanStaleLockFiles, D as archiveSessionTranscripts, E as archiveFileOnDisk, F as stripEnvelopeFromMessages, G as resolveSessionResetPolicy, L as stripInlineDirectiveTagsForDisplay, N as resolveSessionTranscriptCandidates, O as capArrayByJsonBytes, P as stripEnvelopeFromMessage, Q as resolveAgentMainSessionKey, R as stripInlineDirectiveTagsFromMessageForDisplay, S as mergeDeliveryContext, U as evaluateSessionFreshness, X as setSessionRuntimeModel, Z as canonicalizeMainSessionAlias, b as deliveryContextFromSession, c as loadSessionStore, et as resolveMainSessionKey, h as updateSessionStore, j as readSessionPreviewItemsFromTranscript, k as cleanupArchivedSessionTranscripts, n as extractDeliveryInfo, r as parseSessionThreadInfo, rt as snapshotSessionOrigin, tt as resolveMainSessionKeyFromConfig, w as normalizeSessionDeliveryFields } from "./sessions-DGKLiJDU.js";
import { n as listChannelPlugins, o as normalizeWhatsAppTarget, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-CPaMeorQ.js";
import { i as resolveWhatsAppAccount } from "./accounts-CafntguV.js";
import "./accounts--1-XHGvw.js";
import "./accounts-DUEZIYFu.js";
import { t as buildChannelAccountBindings } from "./bindings-B0Nfghiw.js";
import "./logging-D-Jq2wIo.js";
import "./send-D7Pm0pyK.js";
import "./send-BglfZujd.js";
import { $ as BARE_SESSION_RESET_PROMPT, $n as resolveUserTimezone, A as createOutboundSendDeps, Ar as registerAgentRunContext, At as normalizeCronJobPatch, B as buildHistoryContextFromEntries, Bn as resolveInputFileLimits, Bt as stripLegacyDeliveryFields, C as computeBackoff, Cn as isSystemEventContextChanged, Ct as formatRestartSentinelMessage, Dr as emitAgentEvent, Dt as writeRestartSentinel, E as agentCommand, En as requestHeartbeatNow, Er as clearAgentRunContext, Fn as DEFAULT_INPUT_MAX_REDIRECTS, Ft as normalizePayloadToSystemText, Gt as getHookType, In as DEFAULT_INPUT_TIMEOUT_MS, It as normalizeRequiredName, J as dispatchInboundMessage, Jt as persistBrowserProxyFiles, Kn as formatZonedTimestamp, Kt as isExternalHookSession, Ln as extractFileContentFromSource, Lt as migrateLegacyCronPayload, M as createOutboundSendDeps$1, Mn as resolveSendPolicy, Mt as normalizeOptionalAgentId, N as resolveAgentAvatar, Nn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Nt as normalizeOptionalSessionKey, O as resolveAgentDeliveryPlan, Or as getAgentRunContext, Ot as normalizeHttpWebhookUrl, Pn as DEFAULT_INPUT_IMAGE_MIMES, Pt as normalizeOptionalText, Rn as extractImageContentFromSource, Rt as buildDeliveryFromLegacyPayload, S as requestBodyErrorToText, Sn as enqueueSystemEvent, St as formatDoctorNonInteractiveHint, Tr as stripHeartbeatToken, Tt as summarizeRestartSentinel, Ut as buildSafeExternalPrompt, Vn as resolveAgentTimeoutMs, Wt as detectSuspiciousPatterns, X as getTotalPendingReplies, Xn as stopSubagentsForRequester, Y as createReplyDispatcher, Yn as isAbortRequestText, Yt as resolveSessionAuthProfileOverride, _ as loadPowPowPlugins, _r as resetAllLanes, _t as resetDirectoryCache, a as runSubagentAnnounceFlow, an as emitGatewayRestart, ar as resolveTtsAutoMode, at as createPowPowTools, b as handleSlackHttpRequest, br as CommandLane, c as abortEmbeddedPiRun, cn as scheduleGatewaySigusr1Restart, cr as resolveTtsProviderOrder, d as applyToolPolicyPipeline, dn as unbindThreadBindingsBySessionKey, dr as textToSpeech, en as applyModelOverrideToSessionEntry, er as clearBootstrapSnapshot, f as buildDefaultToolPolicyPipelineSteps, fn as normalizeGroupActivation, fr as OPENAI_TTS_MODELS, gr as getTotalQueueSize, h as resolvePluginTools, ht as resolveOutboundChannelPlugin, in as deferGatewayRestartUntilIdle, ir as resolveTtsApiKey, it as runCliAgent, j as createDefaultDeps, jn as normalizeSendPolicy, jt as inferLegacyName, k as resolveAgentOutboundTarget, kr as onAgentEvent, kt as normalizeCronJobCreate, l as getActiveEmbeddedRunCount, ln as setGatewaySigusr1RestartPolicy, lr as setTtsEnabled, lt as ensureOutboundSessionEntry, m as getPluginToolMeta, mn as loadProviderUsageSummary, mr as getActiveTaskCount, mt as resolveSessionDeliveryTarget, n as initSubagentRegistry, nn as parseVerboseOverride, nr as isTtsEnabled, nt as getCliSessionId, o as clearSessionQueues, on as isGatewaySigusr1RestartExternallyAllowed, or as resolveTtsConfig, ot as readLatestAssistantReply, pr as OPENAI_TTS_VOICES, pt as resolveOutboundTarget, qt as applyBrowserProxyPaths, r as listDescendantRunsForRequester, rn as consumeGatewaySigusr1RestartAuthorization, rr as isTtsProviderConfigured, rt as setCliSessionId, s as runEmbeddedPiAgent, sn as markGatewaySigusr1RestartHandled, sr as resolveTtsPrefsPath, st as resolveAnnounceTargetFromKey, t as countActiveDescendantRuns, tn as applyVerboseOverride, tr as getTtsProvider, tt as resolveCronStyleNow, u as waitForEmbeddedPiRunEnd, un as setPreRestartDeferralCheck, ur as setTtsProvider, ut as resolveOutboundSessionRoute, vr as setCommandLaneConcurrency, w as sleepWithAbort, x as readJsonBodyWithLimit, xr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, xt as consumeRestartSentinel, yr as waitForActiveTasks, yt as runWithModelFallback, zn as normalizeMimeList, zt as hasLegacyDeliveryHints } from "./subagent-registry-DXZuSN83.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BB4B9o0x.js";
import { i as normalizeInputProvenance } from "./input-provenance-CUAvV3g8.js";
import "./chat-envelope-9mWFsNOQ.js";
import { $ as validateNodePairRejectParams, $t as verifyDeviceSignature, A as validateCronStatusParams, At as PROTOCOL_VERSION, B as validateExecApprovalsGetParams, Bt as rejectDevicePairing, C as validateConfigSetParams, Ct as validateWakeParams, D as validateCronRemoveParams, Dt as validateWizardNextParams, E as validateCronListParams, Et as validateWizardCancelParams, F as validateDevicePairRemoveParams, Ft as buildDeviceAuthPayload, G as validateModelsListParams, Gt as summarizeDeviceTokens, H as validateExecApprovalsNodeSetParams, Ht as requestDevicePairing, I as validateDeviceTokenRevokeParams, It as approveDevicePairing, J as validateNodeInvokeParams, Jt as roleScopesAllow, K as validateNodeDescribeParams, Kt as updatePairedDeviceMetadata, L as validateDeviceTokenRotateParams, Lt as ensureDeviceToken, M as validateDevicePairApproveParams, Mt as errorShape, N as validateDevicePairListParams, O as validateCronRunParams, Ot as validateWizardStartParams, P as validateDevicePairRejectParams, Pt as parseSessionLabel, Q as validateNodePairListParams, Qt as normalizeDevicePublicKeyBase64Url, R as validateExecApprovalRequestParams, Rt as getPairedDevice, S as validateConfigSchemaParams, St as validateUpdateRunParams, T as validateCronAddParams, Tt as validateWebLoginWaitParams, U as validateExecApprovalsSetParams, Ut as revokeDeviceToken, V as validateExecApprovalsNodeGetParams, Vt as removePairedDevice, W as validateLogsTailParams, Wt as rotateDeviceToken, X as validateNodeListParams, Xt as deriveDeviceIdFromPublicKey, Y as validateNodeInvokeResultParams, Z as validateNodePairApproveParams, _ as validateChatInjectParams, _t as validateSkillsStatusParams, a as validateAgentWaitParams, at as validateRequestFrame, b as validateConfigGetParams, bt as validateTalkModeParams, c as validateAgentsFilesGetParams, ct as validateSessionsDeleteParams, d as validateAgentsListParams, dt as validateSessionsPreviewParams, et as validateNodePairRequestParams, f as validateAgentsUpdateParams, ft as validateSessionsResetParams, g as validateChatHistoryParams, gt as validateSkillsInstallParams, h as validateChatAbortParams, ht as validateSkillsBinsParams, i as validateAgentParams, it as validatePushTestParams, j as validateCronUpdateParams, jt as ErrorCodes, k as validateCronRunsParams, kt as validateWizardStatusParams, l as validateAgentsFilesListParams, lt as validateSessionsListParams, m as validateChannelsStatusParams, mt as validateSessionsUsageParams, n as formatValidationErrors, nt as validateNodeRenameParams, o as validateAgentsCreateParams, ot as validateSendParams, p as validateChannelsLogoutParams, pt as validateSessionsResolveParams, q as validateNodeEventParams, qt as verifyDeviceToken, r as validateAgentIdentityParams, rt as validatePollParams, s as validateAgentsDeleteParams, st as validateSessionsCompactParams, tt as validateNodePairVerifyParams, u as validateAgentsFilesSetParams, ut as validateSessionsPatchParams, v as validateChatSendParams, vt as validateSkillsUpdateParams, w as validateConnectParams, wt as validateWebLoginStartParams, x as validateConfigPatchParams, xt as validateToolsCatalogParams, y as validateConfigApplyParams, yt as validateTalkConfigParams, z as validateExecApprovalResolveParams, zt as listDevicePairing } from "./client-FngVpCQH.js";
import { f as loadGatewayTlsRuntime$1, l as authorizeOperatorScopesForMethod, n as callGateway, s as ADMIN_SCOPE$3, u as isNodeRoleMethod } from "./call-Dy4jPY6_.js";
import { c as readJsonFile, l as writeJsonAtomic, s as createAsyncLock } from "./pairing-token-DdQlEK2o.js";
import { t as safeEqualSecret } from "./secret-equal-D-wwMWrm.js";
import { a as isTrustedProxyAddress, c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as resolveHostName, l as resolveClientIp, n as isLoopbackAddress, o as isValidIPv4, p as rawDataToString, r as isLoopbackHost, s as normalizeHostHeader, t as isLocalishHost, u as resolveGatewayBindHost } from "./net-CliLiAjH.js";
import "./ip-cpmUu6M4.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-DVxZdYPM.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-JeXMO5S0.js";
import { a as createBrowserControlContext, i as createBrowserRouteDispatcher, o as startBrowserControlServiceFromConfig, r as resolveSystemRunCommand, s as getMachineDisplayName } from "./with-timeout-BP0yuB9G.js";
import { S as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, w as runGlobalGatewayStopSafely } from "./deliver-Dawegl6G.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-BSgnPBUn.js";
import "./diagnostic-session-state-I4x9gPY4.js";
import { d as loadCronStore, f as resolveCronStorePath, p as saveCronStore } from "./send-7ONYv7zO.js";
import { c as detectMime } from "./image-ops-BsCVl39S.js";
import "./pi-embedded-helpers-DWdt6mA4.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-Vr4z2IvO.js";
import { i as listCoreToolSections, n as PROFILE_OPTIONS, o as resolveCoreToolProfiles } from "./tool-catalog-7y19qjm_.js";
import "./chrome-CwN6j-nF.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-Mny9GO9e.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-BQr6HjtW.js";
import { c as ensureGatewayStartupAuth, l as mergeGatewayTailscaleConfig } from "./server-context-B-VoITNb.js";
import { i as compileSafeRegex } from "./redact-CAjBvpi8.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-BpyuHard.js";
import { t as sameFileIdentity } from "./file-identity-C8MIb5lb.js";
import { n as openFileWithinRoot, r as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-CEkqp78T.js";
import "./paths-B2BIhK5k.js";
import { t as SsrFBlockedError } from "./ssrf-AiRrlY78.js";
import "./store-DBQ7ewOG.js";
import { a as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-61DuVTUr.js";
import { t as movePathToTrash } from "./trash-BnkU_HL9.js";
...
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-BisA89Mu.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-BiY99pg8.js";
import { n as resolveMemorySearchConfig } from "./manager-JprmBt9D.js";
import "./gemini-auth-DjnSSvsE.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-BfYhc_DT.js";
import "./query-expansion-Bb9K0Q_0.js";
import "./retry-CzGGljZW.js";
import { a as ToolInputError } from "./target-errors-C90nZBSX.js";
...
import { r as isRestartEnabled } from "./commands-BVUHpNuP.js";
import "./commands-registry-5aQe-nwe.js";
import { S as extractTextFromChatContent } from "./image-29CasYKc.js";
import "./tool-display-DYQmKeWr.js";
import { d as registerUnhandledRejectionHandler } from "./runner-DY7HbTfW.js";
import { n as loadModelCatalog } from "./model-catalog-ExB4NYZv.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-h5-Hnjki.js";
import "./fetch-CVaUMMnD.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-Bs-EcVjz.js";
import "./nodes-screen-CiR-rj4e.js";
import { a as loadCombinedSessionStoreForGateway, c as resolveGatewaySessionStoreTarget, d as lookupContextTokens, i as listSessionsFromStore, l as resolveSessionModelRef, o as loadSessionEntry, r as listAgentsForGateway, s as pruneLegacyStoreKeys, t as canonicalizeSpawnedByForAgent, u as openVerifiedFileSync } from "./session-utils-CRyymHot.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-Ues3z8jX.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-EdDmn0JB.js";
import { S as registerSkillsChangeListener, _ as requestNodePairing, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, x as getSkillsSnapshotVersion, y as verifyNodeToken } from "./skill-commands-Bc8gbUvd.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CwvkZfTb.js";
import { t as getChannelActivity } from "./channel-activity-Drlj9sA4.js";
import { n as normalizePollInput } from "./polls-DTGTrGlo.js";
import "./tables-z7EsJDzO.js";
import "./server-lifecycle-Bjvkjvkd.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger--7sJQVSl.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-DLVnh6NA.js";
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-CRRq2Feu.js";
...
import { t as formatHelpExamples } from "./help-format-DVoiHgO5.js";
import { n as withProgress } from "./progress-DF7PrFZS.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-BVP5EZDM.js";
import "./replies-B5G-xrXt.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-BNEaJ_0q.js";
import "./prompt-style-BzZR3NGi.js";
import "./pairing-labels-Bxp_mXfU.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CIWasOfj.js";
import { t as ensurePowPowCliOnPath } from "./path-env-DDMTwZSn.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-yEBF5xhU.js";
import { n as inheritOptionFromParent } from "./command-options-Ck7nsSTb.js";
import { t as WizardCancelledError } from "./prompts-BC5TXS0_.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BS0Qj8Nb.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DEzcq91l.js";
import { t as isWithinDir } from "./path-safety-Dg_0nVJD.js";
import "./install-safe-path-DoxY3Jl3.js";
import "./skill-scanner-Cs4mlgip.js";
import { t as buildChannelAccountSnapshot } from "./status-C4MeiRud.js";
import "./channels-status-issues-B_hfqcmH.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-BKtbvu21.js";
...
import "./lifecycle-core-Kl2d7KL2.js";
import "./systemd-hints-Cfyn9qjl.js";
import { t as parsePort$1 } from "./parse-port-BwqGYves.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-CYl1S81n.js";
import "./diagnostics-q5_bR3Ju.js";
import "./table-DfxW26j_.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-B_wUmD_x.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-HMbrKQYz.js";
import { c as resolveNodeCommandAllowlist, l as probeGateway, n as collectEnabledInsecureOrDangerousFlags, s as isNodeCommandAllowed } from "./audit-CLJkuNXV.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-B5P7ZHTv.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-DB4bqdY_.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BYO_E5wI.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-B_c5GFvQ.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-23ILPOVs.js";
import { t as runOnboardingWizard } from "./onboarding-BwuOyEgA.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-DmAvNXKq.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-CsUhRdrr.js";
import "./node-service-w8j5_Ypl.js";
import "./status.update-ByhrLyAv.js";
import { t as installSkill } from "./skills-install-CCcOGgkG.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-D4HEmQCv.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-Bl_aACEx.js";
import { n as forceFreePortAndWait } from "./ports-2Hw0z2wg.js";
...
function resolveAuthForTarget(cfg, target, overrides) {
	...
	const envToken = process.env.POWPOW_GATEWAY_TOKEN?.trim() || "";
	const envPassword = process.env.POWPOW_GATEWAY_PASSWORD?.trim() || "";
...
async function runAutoUpdateCommand(params) {
	...
	if (argv.length === 0) argv.push("PowPow", ...baseArgs);
	try {
		const res = await runCommandWithTimeout(argv, {
			timeoutMs: params.timeoutMs,
			env: { POWPOW_AUTO_UPDATE: "1" }
		});
		return {
			ok: res.code === 0,
			code: res.code,
...
async function runGatewayUpdateCheck(params) {
	...
	const root = await resolvePowPowPackageRoot({
	...
	if (cmp != null && cmp < 0) {
		...
		if (shouldRunUpdateHints && shouldNotify) {
			params.log.info(`update available (${tag}): v${resolved.version} (current v${VERSION}). Run: ${formatCliCommand("PowPow update")}`);
...
function spawnGogServe(cfg) {
	...
	child.on("exit", (code, signal) => {
		...
		if (addressInUse) {
			log$3.warn("gog serve failed to bind (address already in use); stopping restarts. Another watcher is likely running. Set POWPOW_SKIP_GMAIL_WATCHER=1 or stop the other process.");
			watcherProcess = null;
			return;
		}
...
async function runCronIsolatedAgentTurn(params) {
	...
	const isFastTestEnv = process.env.POWPOW_TEST_FAST === "1";
	...
	const embeddedRunError = hasErrorPayload ? lastErrorPayloadText ?? "cron isolated run returned an error payload" : void 0;
	const resolveRunOutcome = (params) => withRunSession({
		status: hasErrorPayload ? "error" : "ok",
		...hasErrorPayload ? { error: embeddedRunError ?? "cron isolated run returned an error payload" } : {},
		summary,
		outputText,
	...
	if (deliveryResult.result) {
		...
		if (!hasErrorPayload || deliveryResult.result.status !== "ok") return resultWithDeliveryMeta;
...
function sortJobs(jobs, sortBy, sortDir) {
	...
	return jobs.toSorted((a, b) => {
		let cmp = 0;
		if (sortBy === "name") cmp = a.name.localeCompare(b.name, void 0, { sensitivity: "base" });
...
function buildGatewayCronService(params) {
	...
	const cronEnabled = process.env.POWPOW_SKIP_CRON !== "1" && params.cfg.cron?.enabled !== false;
...
function isDisabledByEnv$1() {
	if (isTruthyEnvValue(process.env.POWPOW_DISABLE_BONJOUR)) return true;
	if (process.env.VITEST) return true;
	return false;
}
function safeServiceName(name) {
	const trimmed = name.trim();
	return trimmed.length > 0 ? trimmed : "PowPow";
}
function prettifyInstanceName(name) {
	const normalized = name.trim().replace(/\s+/g, " ");
	return normalized.replace(/\s+\(PowPow\)\s*$/i, "").trim() || normalized;
}
...
async function startGatewayBonjourAdvertiser(opts) {
	...
	const hostname = (process.env.POWPOW_MDNS_HOSTNAME?.trim() || process.env.powpow_MDNS_HOSTNAME?.trim() || "PowPow").replace(/\.local$/i, "").split(".")[0].trim() || "PowPow";
	const instanceName = typeof opts.instanceName === "string" && opts.instanceName.trim() ? opts.instanceName.trim() : `${hostname} (PowPow)`;
...
function formatBonjourInstanceName(displayName) {
	...
	if (!trimmed) return "PowPow";
	if (/PowPow/i.test(trimmed)) return trimmed;
	return `${trimmed} (PowPow)`;
}
function resolveBonjourCliPath(opts = {}) {
	const envPath = (opts.env ?? process.env).POWPOW_CLI_PATH?.trim();
	...
	const siblingCli = path.join(execDir, "PowPow");
	...
	const binCli = path.join(cwd, "bin", "PowPow");
	if (isFile(binCli)) return binCli;
}
async function resolveTailnetDnsHint(opts) {
	const envRaw = (opts?.env ?? process.env).POWPOW_TAILNET_DNS?.trim();
...
async function startGatewayDiscovery(params) {
	...
	const bonjourEnabled = mdnsMode !== "off" && process.env.POWPOW_DISABLE_BONJOUR !== "1" && !process.env.VITEST;
	...
	const sshPortEnv = mdnsMinimal ? void 0 : process.env.POWPOW_SSH_PORT?.trim();
...
const getHandshakeTimeoutMs = () => {
	if (process.env.VITEST && process.env.POWPOW_TEST_HANDSHAKE_TIMEOUT_MS) {
		const parsed = Number(process.env.POWPOW_TEST_HANDSHAKE_TIMEOUT_MS);
...
/**
* Build TimestampInjectionOptions from an PowPowConfig.
*/
...
async function resolveAgentWorkspaceFilePath(params) {
	...
	if (!isPathInside(workspaceReal, candidatePath)) return {
		kind: "invalid",
		requestPath,
	...
	if (candidateLstat.isSymbolicLink()) {
		...
		if (!isPathInside(workspaceReal, targetReal)) return {
			kind: "invalid",
			requestPath,
			reason: "symlink target escapes workspace root"
		};
		try {
			if (!(await fs$1.stat(targetReal)).isFile()) return {
				kind: "invalid",
				requestPath,
				reason: "symlink target is not a file"
			};
		} catch (err) {
			if (isNotFoundPathError(err) && params.allowMissing) return {
				kind: "missing",
				requestPath,
				ioPath: targetReal,
				workspaceReal
	...
	const candidateReal = await fs$1.realpath(candidatePath).catch(() => candidatePath);
	if (!isPathInside(workspaceReal, candidateReal)) return {
		kind: "invalid",
		requestPath,
		reason: "resolved file escapes workspace root"
	};
	return {
		kind: "ready",
		requestPath,
		ioPath: candidateReal,
		workspaceReal
	};
}
...
async function writeFileSafely(filePath, content) {
	const handle = await fs$1.open(filePath, OPEN_WRITE_FLAGS, 384);
	try {
		const [stat, lstat] = await Promise.all([handle.stat(), fs$1.lstat(filePath)]);
		if (lstat.isSymbolicLink() || !stat.isFile()) throw new Error("unsafe file path");
		if (!sameFileIdentity(stat, lstat)) throw new Error("path changed during write");
...
const agentsHandlers = {
	...
	"agents.files.get": async ({ params, respond }) => {
		...
		if (resolvedPath.kind === "invalid") {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `unsafe workspace file "${name}" (${resolvedPath.reason})`));
			return;
		}
...
function buildBaseConfigSchema() {
	...
	const schema = PowPowSchema.toJSONSchema({
		target: "draft-07",
		unrepresentable: "any"
	});
	schema.title = "PowPowConfig";
	const hints = applyDerivedTags(mapSensitivePaths(PowPowSchema, "", buildBaseHints()));
	const next = {
...
const MAX_LIMIT = 5e3;
const MAX_BYTES = 1e6;
const ROLLING_LOG_RE = /^powpow-\d{4}-\d{2}-\d{2}\.log$/;
...
function argvMatchesRequest(requestedArgv, argv) {
	if (requestedArgv.length === 0 || requestedArgv.length !== argv.length) return false;
	for (let i = 0; i < requestedArgv.length; i += 1) if (requestedArgv[i] !== argv[i]) return false;
	return true;
}
function approvalMatchesSystemRunRequest(params) {
	if (params.request.host !== "node") return false;
	const requestedArgv = params.request.commandArgv;
	if (Array.isArray(requestedArgv)) {
		if (!argvMatchesRequest(requestedArgv, params.argv)) return false;
	} else if (!params.cmdText || params.request.command !== params.cmdText) return false;
	if ((params.request.cwd ?? null) !== params.binding.cwd) return false;
	if ((params.request.agentId ?? null) !== params.binding.agentId) return false;
	if ((params.request.sessionKey ?? null) !== params.binding.sessionKey) return false;
	return true;
}
...
function sanitizeSystemRunParamsForForwarding(opts) {
	...
	if (approvalNodeId !== targetNodeId) return {
		ok: false,
	...
	if (!approvalMatchesSystemRunRequest({
		cmdText,
	...
	if (snapshot.decision === "allow-once") {
		if (typeof manager.consumeAllowOnce !== "function" || !manager.consumeAllowOnce(runId)) return {
			ok: false,
...
async function maybeSendNodeWakeNudge(nodeId) {
	...
	try {
		const result = await sendApnsAlert({
			...
			registration,
			nodeId,
			title: "PowPow needs a quick reopen",
			body: "Tap to reopen PowPow and restore the node connection."
		});
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DrnTMgoT.js");
...
const pushHandlers = { "push.test": async ({ params, respond }) => {
	...
	const title = normalizeOptionalString(params.title) ?? "PowPow";
...
const updateHandlers = { "update.run": async ({ params, respond, client, context }) => {
	...
	try {
		...
		result = await runGatewayUpdate({
			timeoutMs,
			cwd: await resolvePowPowPackageRoot({
				moduleUrl: import.meta.url,
				argv1: process.argv[1],
				cwd: process.cwd()
			}) ?? process.cwd(),
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-Ues3z8jX.js").then((n) => n.a);
...
function createExecApprovalHandlers(manager, opts) {
	...
	return {
		"exec.approval.request": async ({ params, respond, context, client }) => {
			...
			const commandArgv = Array.isArray(p.commandArgv) ? p.commandArgv.map((entry) => String(entry)) : void 0;
			if (host === "node" && !nodeId) {
...
function loadGatewayPlugins(params) {
	const pluginRegistry = loadPowPowPlugins({
		config: params.cfg,
...
async function startGmailWatcherWithLogs(params) {
	if (isTruthyEnvValue(process.env.POWPOW_SKIP_GMAIL_WATCHER)) {
		params.onSkipped?.();
		return;
	}
	try {
...
function extractHookToken(req) {
	...
	const headerToken = typeof req.headers["x-powpow-token"] === "string" ? req.headers["x-powpow-token"].trim() : "";
...
async function startBrowserControlServerIfEnabled() {
	if (isTruthyEnvValue(process.env.POWPOW_SKIP_BROWSER_CONTROL_SERVER)) return null;
	const override = process.env.POWPOW_BROWSER_CONTROL_MODULE?.trim();
	const mod = override ? await import(override) : await import("./server-CD1KXPz-.js");
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			...
			await startGmailWatcherWithLogs({
				cfg: nextConfig,
				log: params.logHooks,
				onSkipped: () => params.logHooks.info("skipping gmail watcher restart (POWPOW_SKIP_GMAIL_WATCHER=1)")
			});
		}
		if (plan.restartChannels.size > 0) if (isTruthyEnvValue(process.env.POWPOW_SKIP_CHANNELS) || isTruthyEnvValue(process.env.POWPOW_SKIP_PROVIDERS)) params.logChannels.info("skipping channel reload (POWPOW_SKIP_CHANNELS=1 or POWPOW_SKIP_PROVIDERS=1)");
		else {
...
async function resolveGatewayRuntimeConfig(params) {
	...
	const canvasHostEnabled = process.env.POWPOW_SKIP_CANVAS_HOST !== "1" && params.cfg.canvasHost?.enabled !== false;
	...
	if (tailscaleMode === "funnel" && authMode !== "password") throw new Error("tailscale funnel requires gateway auth mode=password (set gateway.auth.password or POWPOW_GATEWAY_PASSWORD)");
	...
	if (!isLoopbackHost(bindHost) && !hasSharedSecret && authMode !== "trusted-proxy") throw new Error(`refusing to bind gateway to ${bindHost}:${params.port} without auth (set gateway.auth.token/password, or set POWPOW_GATEWAY_TOKEN/POWPOW_GATEWAY_PASSWORD)`);
...
const A2UI_PATH = "/__POWPOW__/a2ui";
const CANVAS_HOST_PATH = "/__POWPOW__/canvas";
const CANVAS_WS_PATH = "/__POWPOW__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.PowPowCanvasA2UIAction.postMessage(...)
  // - Android: window.PowPowCanvasA2UIAction.postMessage(...)
  const handlerNames = ["PowPowCanvasA2UIAction"];
  ...
  globalThis.PowPow = globalThis.PowPow ?? {};
  globalThis.PowPow.postMessage = postToNode;
  globalThis.PowPow.sendUserAction = sendUserAction;
  globalThis.PowPowPostMessage = postToNode;
  globalThis.PowPowSendUserAction = sendUserAction;
...
(() => {
  ...
  const hasIOS = () =>
    !!(
      ...
      window.webkit.messageHandlers.PowPowCanvasA2UIAction
    );
  const hasAndroid = () =>
    !!(
      (window.PowPowCanvasA2UIAction &&
        typeof window.PowPowCanvasA2UIAction.postMessage === "function")
    );
  const hasHelper = () => typeof window.PowPowSendUserAction === "function";
  statusEl.innerHTML =
    "Bridge: " +
  ...
  window.addEventListener("PowPow:a2ui-action-status", onStatus);

  function send(name, sourceComponentId) {
    if (!hasHelper()) {
      log("No action bridge found. Ensure you're viewing this on an iOS/Android PowPow node canvas.");
      return;
    }
    const sendUserAction =
      typeof window.PowPowSendUserAction === "function"
        ? window.PowPowSendUserAction
        : undefined;
...
function isDisabledByEnv() {
	if (isTruthyEnvValue(process.env.POWPOW_SKIP_CANVAS_HOST)) return true;
	if (isTruthyEnvValue(process.env.POWPOW_SKIP_CANVAS_HOST)) return true;
	if (process.env.VITEST) return true;
	return false;
}
		...
		try {
			...
			if (!opened) {
				if (urlPath === "/" || urlPath.endsWith("/")) {
					res.statusCode = 404;
					res.setHeader("Content-Type", "text/html; charset=utf-8");
					res.end(`<!doctype html><meta charset="utf-8" /><title>PowPow Canvas</title><pre>Missing file.\nCreate ${rootDir}/index.html</pre>`);
					return true;
				}
				res.statusCode = 404;
				res.setHeader("Content-Type", "text/plain; charset=utf-8");
...
const CANVAS_CAPABILITY_PATH_PREFIX = "/__POWPOW__/cap";
...
const CONTROL_UI_BOOTSTRAP_CONFIG_PATH = "/__PowPow/control-ui-config.json";
...
function resolveAgentIdFromHeader(req) {
	const raw = getHeader(req, "x-powpow-agent-id")?.trim() || getHeader(req, "x-powpow-agent")?.trim() || "";
	if (!raw) return;
...
function resolveAgentIdFromModel(model) {
	...
	if (!raw) return;
	const agentId = (raw.match(/^PowPow[:/](?<agentId>[a-z0-9][a-z0-9_-]{0,63})$/i) ?? raw.match(/^agent:(?<agentId>[a-z0-9][a-z0-9_-]{0,63})$/i))?.groups?.agentId;
	if (!agentId) return;
...
function resolveSessionKey(params) {
	const explicit = getHeader(params.req, "x-powpow-session-key")?.trim();
...
function resolveAgentResponseText(result) {
	...
	if (!Array.isArray(payloads) || payloads.length === 0) return "No response from PowPow.";
	return payloads.map((p) => typeof p.text === "string" ? p.text : "").filter(Boolean).join("\n\n") || "No response from PowPow.";
}
async function handleOpenAiHttpRequest(req, res, opts) {
	...
	const model = typeof payload.model === "string" ? payload.model : "PowPow";
...
*
* Implements the OpenResponses `/v1/responses` endpoint for PowPow Gateway.
*
* @see https://www.open-responses.com/
*/
...
async function handleOpenResponsesHttpRequest(req, res, opts) {
	...
	unsubscribe = onAgentEvent((evt) => {
		...
		if (evt.stream === "lifecycle") {
			const phase = evt.data?.phase;
			if (phase === "end" || phase === "error") requestFinalize(phase === "error" ? "failed" : "completed", accumulatedText || "No response from PowPow.");
		}
	});
	req.on("close", () => {
		closed = true;
...
async function handleToolsInvokeHttpRequest(req, res, opts) {
	...
	const messageChannel = normalizeMessageChannel(getHeader(req, "x-powpow-message-channel") ?? "");
	const accountId = getHeader(req, "x-powpow-account-id")?.trim() || void 0;
	const agentTo = getHeader(req, "x-powpow-message-to")?.trim() || void 0;
	const agentThreadId = getHeader(req, "x-powpow-thread-id")?.trim() || void 0;
...
function createHooksRequestHandler(opts) {
	...
	return async (req, res) => {
		...
		if (url.searchParams.has("token")) {
			res.statusCode = 400;
			res.setHeader("Content-Type", "text/plain; charset=utf-8");
			res.end("Hook token must be provided via Authorization: Bearer <token> or X-powpow-Token header (query parameters are not allowed).");
			return true;
		}
...
function createGatewayHttpServer(opts) {
	const { canvasHost, clients, controlUiEnabled, controlUiBasePath, controlUiRoot, openAiChatCompletionsEnabled, openResponsesEnabled, openResponsesConfig, strictTransportSecurityHeader, handleHooksRequest, handlePluginRequest, resolvedAuth, rateLimiter } = opts;
...
function isGatewayArgv(args) {
	...
	return exe.endsWith("/PowPow") || exe === "PowPow";
}
...
async function acquireGatewayLock(opts = {}) {
	...
	if (env.POWPOW_ALLOW_MULTI_GATEWAY === "1" || !allowInTests && (env.VITEST || env.NODE_ENV === "test")) return null;
...
function logGatewayStartup(params) {
	...
	if (enabledDangerousFlags.length > 0) {
		const warning = `security warning: dangerous config flags enabled: ${enabledDangerousFlags.join(", ")}. Run \`PowPow security audit\`.`;
...
*/
const IMMUTABLE_SOURCES = new Set(["powpow-bundled"]);
...
*
* @param cfg - PowPow configuration
...
async function loadInternalHooks(cfg, workspaceDir, opts) {
	...
	for (const handlerConfig of handlers) try {
		...
		const mod = await import(buildImportUrl(modulePath, "powpow-workspace"));
...
async function startGatewaySidecars(params) {
	...
	if (!(isTruthyEnvValue(process.env.POWPOW_SKIP_CHANNELS) || isTruthyEnvValue(process.env.POWPOW_SKIP_PROVIDERS))) try {
		await params.startChannels();
	} catch (err) {
		params.logChannels.error(`channel startup failed: ${String(err)}`);
	}
	else params.logChannels.info("skipping channel start (POWPOW_SKIP_CHANNELS=1 or POWPOW_SKIP_PROVIDERS=1)");
	...
	socket.on("message", async (data) => {
		...
		try {
			...
			if (!client) {
				...
				const skipPairing = shouldSkipControlUiPairing(controlUiAuthPolicy, sharedAuthOk, isTrustedProxyControlUiOperatorAuth({
					isControlUi,
					role,
					authMode: resolvedAuth.mode,
					authOk,
...
async function startGatewayServer(port = 18789, opts = {}) {
	const minimalTestGateway = process.env.VITEST === "1" && process.env.POWPOW_TEST_MINIMAL_GATEWAY === "1";
	process.env.POWPOW_GATEWAY_PORT = String(port);
	logAcceptedEnvOption({
		key: "POWPOW_RAW_STREAM",
		description: "raw stream logging enabled"
	});
	logAcceptedEnvOption({
		key: "POWPOW_RAW_STREAM_PATH",
	...
	if (configSnapshot.legacyIssues.length > 0) {
		...
		if (!migrated) throw new Error(`Legacy config entries detected but auto-migration failed. Run "${formatCliCommand("PowPow doctor")}" to migrate.`);
	...
	if (configSnapshot.exists && !configSnapshot.valid) {
		...
		throw new Error(`Invalid config at ${configSnapshot.path}.\n${issues}\nRun "${formatCliCommand("PowPow doctor")}" to repair, then retry.`);
	}
	...
	else log.warn("Gateway auth token was missing. Generated a runtime token for this startup without changing config; restart will generate a different token. Persist one with `PowPow config set gateway.auth.mode token` and `PowPow config set gateway.auth.token <token>`.");
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-DE4JWfi8.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-Dawegl6G.js").then((n) => n.n);
...
const resolveDevWorkspaceDir = (env = process.env) => {
	...
	if (env.POWPOW_PROFILE?.trim().toLowerCase() === "dev") return baseDir;
...
async function ensureDevWorkspace(dir) {
	...
	const [agents, soul, tools, identity, user] = await Promise.all([
		loadDevTemplate("AGENTS.dev.md", `# AGENTS.md - PowPow Dev Workspace\n\nDefault dev workspace for PowPow gateway --dev.\n`),
...
* - POWPOW_NO_RESPAWN=1: caller should keep in-process restart behavior (tests/dev)
* - otherwise: spawn detached child with current argv/execArgv, then caller exits
*/
function restartGatewayProcessWithFreshPid() {
	if (isTruthy(process.env.POWPOW_NO_RESPAWN)) return { mode: "disabled" };
...
async function runGatewayLoop(params) {
	...
	const handleRestartAfterServerClose = async () => {
		...
		else gatewayLog$1.info("restart mode: in-process restart (POWPOW_NO_RESPAWN)");
...
async function runGatewayCommand$1(opts) {
	const isDevProfile = process.env.POWPOW_PROFILE?.trim().toLowerCase() === "dev";
	...
	if (opts.claudeCliLogs) {
		...
		process.env.POWPOW_CLAUDE_CLI_LOG_OUTPUT = "1";
	}
	...
	if (opts.rawStream) process.env.POWPOW_RAW_STREAM = "1";
	const rawStreamPath = toOptionString(opts.rawStreamPath);
	if (rawStreamPath) process.env.POWPOW_RAW_STREAM_PATH = rawStreamPath;
	...
	if (opts.token) {
		...
		if (token) process.env.POWPOW_GATEWAY_TOKEN = token;
	}
	...
	if (!opts.allowUnconfigured && mode !== "local") {
		if (!configExists) defaultRuntime.error(`Missing config. Run \`${formatCliCommand("PowPow setup")}\` or set gateway.mode=local (or pass --allow-unconfigured).`);
		else {
	...
	if (resolvedAuthMode === "password" && !hasPassword) {
		defaultRuntime.error([
			...
			"Set gateway.auth.password (or POWPOW_GATEWAY_PASSWORD), or pass --password.",
			...authHints
		].filter(Boolean).join("\n"));
		defaultRuntime.exit(1);
		return;
	...
	if (bind !== "loopback" && !hasSharedSecret && !canBootstrapToken && resolvedAuthMode !== "trusted-proxy") {
		defaultRuntime.error([
			...
			"Set gateway.auth.token/password (or POWPOW_GATEWAY_TOKEN/POWPOW_GATEWAY_PASSWORD) or pass --token/--password.",
			...authHints
		].filter(Boolean).join("\n"));
		defaultRuntime.exit(1);
		return;
	...
	try {
		...
		if (err instanceof GatewayLockError || err && typeof err === "object" && err.name === "GatewayLockError") {
			...
			defaultRuntime.error(`Gateway failed to start: ${errMessage}\nIf the gateway is supervised, stop it with: ${formatCliCommand("PowPow gateway stop")}`);
			try {
...
function registerGatewayCli(program) {
	const gateway = addGatewayRunCommand(program.command("gateway").description("Run, inspect, and query the WebSocket Gateway").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		["PowPow gateway run", "Run the gateway in the foreground."],
		["PowPow gateway status", "Show service status and probe reachability."],
		["PowPow gateway discover", "Find local and wide-area gateway beacons."],
		["PowPow gateway call health", "Call a gateway RPC method directly."]
	])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.PowPow.ai/cli/gateway")}\n`));
