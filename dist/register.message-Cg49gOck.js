...
import { T as normalizeChatChannelId, f as defaultRuntime, x as getChatChannelMeta } from "./subsystem-DXlyH4H4.js";
import { D as danger, N as setVerbose, R as isRich, z as theme } from "./utils-BWJH7VRh.js";
...
import { t as getChannelPlugin } from "./plugins-CPaMeorQ.js";
...
import { A as createOutboundSendDeps, Ht as CHANNEL_TARGET_DESCRIPTION, Vt as CHANNEL_TARGETS_DESCRIPTION, ct as runMessageAction, gt as formatTargetDisplay, j as createDefaultDeps, vt as CHANNEL_MESSAGE_ACTION_NAMES } from "./subagent-registry-DXZuSN83.js";
...
import { w as runGlobalGatewayStopSafely } from "./deliver-Dawegl6G.js";
...
import { t as collectOption } from "./helpers-Doq6E0RM.js";
...
${formatHelpExamples([
		["PowPow message send --target +15555550123 --message \"Hi\"", "Send a text message."],
		["PowPow message send --target +15555550123 --message \"Hi\" --media photo.jpg", "Send a message with media."],
		["PowPow message poll --channel discord --target channel:123 --poll-question \"Snack?\" --poll-option Pizza --poll-option Sushi", "Create a Discord poll."],
		["PowPow message react --channel discord --target 123 --message-id 456 --emoji \"✅\"", "React to a message."]
	])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.PowPow.ai/cli/message")}`).action(() => {
