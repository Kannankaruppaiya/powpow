import { S as ensureChromeExtensionRelayServer } from "./chrome-CwN6j-nF.js";
import { a as resolveProfile, n as listKnownProfileNames, t as createBrowserRouteContext } from "./server-context-B-VoITNb.js";
...
async function stopKnownBrowserProfiles(params) {
	...
	try {
		...
		params.onWarn(`PowPow browser stop failed: ${String(err)}`);
	}
}
