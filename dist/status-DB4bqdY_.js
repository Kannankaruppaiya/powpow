...
import { u as resolveGatewayPort } from "./paths-BJtes5yu.js";
import { O as info, R as isRich, z as theme } from "./utils-BWJH7VRh.js";
import { Jt as DEFAULT_MODEL, U as resolveConfiguredModelRef, Yt as DEFAULT_PROVIDER, qt as DEFAULT_CONTEXT_TOKENS } from "./auth-profiles-KPMal-k-.js";
import { t as formatCliCommand } from "./command-format-DRH7uGKn.js";
import { u as resolveAgentWorkspaceDir } from "./agent-scope-Ac0Vygcn.js";
import { w as parseAgentSessionKey } from "./session-key-DXmKFT2p.js";
...
import { i as loadConfig, o as readConfigFileSnapshot } from "./config-B91e8u6L.js";
import { r as VERSION } from "./env-vars-D53NnL-N.js";
import { Y as resolveFreshSessionTotalTokens, c as loadSessionStore, et as resolveMainSessionKey } from "./sessions-DGKLiJDU.js";
import { n as listChannelPlugins } from "./plugins-CPaMeorQ.js";
import { Tn as peekSystemEvents, Tt as summarizeRestartSentinel, bn as formatChannelAllowFrom, hn as formatUsageReportLines, mn as loadProviderUsageSummary, vn as buildChannelSummary, wt as readRestartSentinel, yn as buildChannelAccountSnapshot } from "./subagent-registry-DXZuSN83.js";
import { l as resolveStorePath } from "./paths-BB4B9o0x.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-Dy4jPY6_.js";
import { o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-Mny9GO9e.js";
import { a as formatPortDiagnostics, n as inspectPortUsage } from "./ports-61DuVTUr.js";
import { r as getMemorySearchManager } from "./memory-cli-BiY99pg8.js";
...
import { f as resolveContextTokensForModel, l as resolveSessionModelRef, n as classifySessionKey, r as listAgentsForGateway } from "./session-utils-CRyymHot.js";
import { o as getRemoteSkillEligibility } from "./skill-commands-Bc8gbUvd.js";
import { a as sha256HexPrefix } from "./active-listener-88U6O7kw.js";
import { n as withProgress } from "./progress-DF7PrFZS.js";
import { C as normalizeControlUiBasePath, g as resolveControlUiLinks } from "./onboard-helpers-BNEaJ_0q.js";
...
import { s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-DkDZ7shP.js";
import { t as formatRuntimeStatusWithDetails } from "./runtime-status-BpfhKQlP.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-q5_bR3Ju.js";
import { t as renderTable } from "./table-DfxW26j_.js";
import { l as probeGateway, o as resolveGatewayProbeAuth$1, t as runSecurityAudit } from "./audit-CLJkuNXV.js";
import { o as resolveHeartbeatSummaryForAgent, t as formatHealthChannelLines } from "./health-BYO_E5wI.js";
import { _ as resolveUpdateChannelDisplay, a as formatGitInstallLabel, h as normalizeUpdateChannel, n as checkUpdateStatus, t as resolveDefaultChannelAccountContext } from "./channel-account-context-23ILPOVs.js";
import { t as resolveNodeService } from "./node-service-w8j5_Ypl.js";
import { n as redactSecrets, t as formatGatewayAuthUsed } from "./format-DPV8QZPM.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-ByhrLyAv.js";
import { t as shortenText } from "./text-format-CK-9sIyt.js";
...
async function appendStatusAllDiagnosis(params) {
	...
	lines.push("Troubleshooting: https://docs.PowPow.ai/troubleshooting");
	lines.push("");
}
...
async function buildStatusAllReportLines(params) {
	...
	const lines = [];
	lines.push(heading("PowPow status --all"));
	lines.push("");
...
async function statusAllCommand(runtime, opts) {
	await withProgress({
		...
		const update = await checkUpdateStatus({
			root: await resolvePowPowPackageRoot({
		...
		const lines = await buildStatusAllReportLines({
			...
			overviewRows: [
				...
				{
					Item: "Security",
					Value: `Run: ${formatCliCommand("PowPow security audit --deep")}`
				},
				gatewaySelfLine ? {
					Item: "Gateway self",
...
async function scanStatus(opts, _runtime) {
	return await withProgress({
		...
		progress.tick();
		progress.setLabel("Summarizing channels…");
		const channels = await buildChannelsTable(cfg, { showSecrets: process.env.powpow_SHOW_SECRETS?.trim() !== "0" });
		progress.tick();
...
async function statusCommand(opts, runtime) {
	...
	runtime.log(theme.heading("PowPow status"));
	runtime.log("");
	...
	if (pairingRecovery) {
		...
		if (pairingRecovery.requestId) runtime.log(theme.muted(`Recovery: ${formatCliCommand(`PowPow devices approve ${pairingRecovery.requestId}`)}`));
		runtime.log(theme.muted(`Fallback: ${formatCliCommand("PowPow devices approve --latest")}`));
		runtime.log(theme.muted(`Inspect: ${formatCliCommand("PowPow devices list")}`));
	}
	runtime.log("");
	...
	runtime.log(theme.muted(`Full report: ${formatCliCommand("PowPow security audit")}`));
	runtime.log(theme.muted(`Deep probe: ${formatCliCommand("PowPow security audit --deep")}`));
	runtime.log("");
	...
	runtime.log("");
	runtime.log("FAQ: https://docs.PowPow.ai/faq");
	runtime.log("Troubleshooting: https://docs.PowPow.ai/troubleshooting");
	runtime.log("");
	...
	runtime.log(`  Need to share?      ${formatCliCommand("PowPow status --all")}`);
	runtime.log(`  Need to debug live? ${formatCliCommand("PowPow logs --follow")}`);
	if (gatewayReachable) runtime.log(`  Need to test channels? ${formatCliCommand("PowPow status --deep")}`);
	else runtime.log(`  Fix reachability first: ${formatCliCommand("PowPow gateway probe")}`);
}
