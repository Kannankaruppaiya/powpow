...
import { _ as isBlockedObjectKey } from "./session-key-DXmKFT2p.js";
...
import { t as redactConfigObject } from "./redact-snapshot-BKtbvu21.js";
...
async function loadValidConfig(runtime = defaultRuntime) {
	...
	runtime.error(`Run \`${formatCliCommand("PowPow doctor")}\` to repair, then retry.`);
	runtime.exit(1);
	return snapshot;
}
