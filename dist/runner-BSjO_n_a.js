...
import { $ as shouldLogVerbose, X as logVerbose, t as createSubsystemLogger, ut as resolvePreferredPowPowTmpDir } from "./subsystem-3xhEFOyH.js";
import { _ as runExec } from "./workspace-BbD3Kass.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolvePowPowAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-MeurW_4a.js";
import { t as normalizeChatType } from "./chat-type-CH3W-zKy.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-CIlRVMHI.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-BVY11kC2.js";
import { t as describeImageWithModel, w as ensurePowPowModelsJson } from "./image-BIA1_Uyx.js";
...
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-3Pj1Y1p4.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-u0oFU09B.js")).ensurePiAuthJsonFromAuthProfiles(resolvePowPowAgentDir());
