...
import { B as theme, P as setVerbose, Q as tryParseLogLevel, T as toWhatsappJid, Y as ALLOWED_LOG_LEVELS, l as escapeRegExp, m as normalizeE164, n as assertWebChannel, z as isRich } from "./utils-C9Yd70Dr.js";
import "./thinking-EAliFiVK.js";
import { Gt as createDefaultDeps, Tt as resolveCommitHash, t as getReplyFromConfig } from "./reply-DXKoJPvW.js";
import "./agent-scope-Coqt3COl.js";
import { f as defaultRuntime, r as enableConsoleCapture, u as visibleWidth } from "./subsystem-A8uKC1In.js";
...
import { n as replaceCliName, r as resolveCliName } from "./command-format-DpXmP5EG.js";
import "./boolean-CE7i9tBR.js";
import { r as normalizeEnv, t as isTruthyEnvValue } from "./env-BF71IqS7.js";
import "./host-env-security-IP2UsfGZ.js";
import "./message-channel-Bc5gLV-e.js";
import "./send-BYGkmhGE.js";
import { Mt as loadDotEnv, i as loadConfig } from "./config-ClR1jZcN.js";
import { r as VERSION } from "./env-vars-C_dl05a-.js";
import "./manifest-registry-jY2uQzFh.js";
import "./dock-Dwi_4IIN.js";
import { _ as applyTemplate, u as installUnhandledRejectionHandler } from "./runner-D5ewLVko.js";
...
import { l as ensureBinary, u as promptYesNo } from "./tailscale-DSZX1Br_.js";
...
import { r as formatUncaughtError } from "./errors-Adli4uDW.js";
...
import { i as handlePortError, n as describePortOwner, r as ensurePortAvailable, t as PortInUseError } from "./ports-BB-_Dytw.js";
import "./trash-B0HKkPsm.js";
import "./server-middleware-BiteXZ6h.js";
import { B as resolveSessionKey, c as loadSessionStore, p as saveSessionStore, z as deriveSessionKey } from "./sessions-fBW7dZrm.js";
...
import { r as waitForever, t as monitorWebChannel } from "./channel-web-DW2aAM52.js";
...
const DEFAULT_TAGLINE = "All your chats, one PowPow.";
...
function pickTagline(options = {}) {
	const override = (options.env ?? process.env)?.POWPOW_TAGLINE_INDEX;
	if (override !== void 0) {
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-DlcffhHV.js");
		await ensureConfigReady({
			runtime: defaultRuntime,
			commandPath
		});
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-BsxhYVsm.js").then((n) => n.n);
...
if (isMainModule({ currentFile: fileURLToPath(import.meta.url) })) {
	...
	program.parseAsync(process$1.argv).catch((err) => {
		console.error("[powpow] CLI failed:", formatUncaughtError(err));
		process$1.exit(1);
	});
}
