...
import { zt as resolvePowPowAgentDir } from "./model-selection-DAT49TVG.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DOnkTbEw.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-eKavXdQM.js")).ensurePiAuthJsonFromAuthProfiles(resolvePowPowAgentDir());
