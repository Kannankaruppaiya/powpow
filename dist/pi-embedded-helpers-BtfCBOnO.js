import { D as runExec, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-DxSdR-i1.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-B4N4CZDb.js";
import { K as truncateUtf16Safe, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-J2JHz_PH.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-YGVrIVO5.js";
import { n as parseBooleanValue, r as formatCliCommand } from "./env-srzc75vD.js";
import { t as generateSecureToken } from "./secure-random-BEYczWtd.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-BV6UX3uC.js";
import { _ as getBlockedNetworkModeReason, n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-ctWck2-F.js";
import { A as resolveWritablePathWithinRoot, B as DEFAULT_POWPOW_BROWSER_PROFILE_NAME, C as stopChromeExtensionRelayServer, D as DEFAULT_UPLOAD_DIR, E as DEFAULT_TRACE_DIR, F as DEFAULT_AI_SNAPSHOT_MAX_CHARS, I as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, L as DEFAULT_BROWSER_EVALUATE_ENABLED, N as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, O as resolveExistingPathsWithinRoot, P as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, R as DEFAULT_POWPOW_BROWSER_COLOR, S as ensureChromeExtensionRelayServer, T as DEFAULT_DOWNLOAD_DIR, _ as appendCdpPath, a as resolvePowPowUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as withBrowserNavigationPolicy, h as assertBrowserNavigationResultAllowed, i as launchPowPowChrome, j as isLoopbackHost, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopPowPowChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchJson, y as fetchOk, z as DEFAULT_POWPOW_BROWSER_ENABLED } from "./chrome-B9a6n_p9.js";
import { t as SsrFBlockedError } from "./ssrf-PljZpPCf.js";
import { a as syncSkillsToWorkspace, f as PATH_ALIAS_POLICIES, g as sanitizeEnvVars, l as resolveSandboxInputPath, p as assertNoPathAliasEscape, u as resolveSandboxPath } from "./skills-jpyWEUPA.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-D9rAZNPr.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-CQH0lIM2.js";
import { B as canonicalizeMainSessionAlias, K as acquireSessionWriteLock, V as resolveAgentMainSessionKey } from "./sessions-DEZJJ1nc.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-4k3CXsyz.js";
import { o as normalizeThinkLevel } from "./thinking-BiUfNrGG.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai--US7RMt8.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai--US7RMt8.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { stripPluginOnlyAllowlist as $, isTimeoutErrorMessage as A, resolveBrowserConfig as B, isCompactionFailureError as C, isLikelyContextOverflowError as D, isFailoverErrorMessage as E, ensureSandboxWorkspaceForSession as F, resolveGatewayCredentialsFromConfig as G, getBridgeAuthForPort as H, resolveSandboxContext as I, applyOwnerOnlyToolPolicy as J, trimToUndefined as K, resolveSandboxRuntimeStatus as L, parseImageDimensionError as M, parseImageSizeError as N, isRateLimitAssistantError as O, sanitizeUserFacingText as P, mergeAlsoAllowPolicy as Q, createBrowserRouteContext as R, isCloudCodeAssistFormatError as S, isFailoverAssistantError as T, ensureBrowserControlAuth as U, resolveProfile as V, resolveBrowserControlAuth as W, collectExplicitAllowlist as X, buildPluginToolGroups as Y, expandPolicyWithPluginGroups as Z, formatRawAssistantErrorForUi as _, isMessagingToolDuplicateNormalized as a, buildBootstrapContextFiles as at, isAuthPermanentErrorMessage as b, extractToolCallsFromAssistant as c, resolveBootstrapTotalMaxChars as ct, downgradeOpenAIReasoningBlocks as d, expandToolGroups as et, isGoogleModelApi as f, formatBillingErrorMessage as g, formatAssistantErrorText as h, isMessagingToolDuplicate as i, matchesAnyGlobPattern as it, isTransientHttpError as j, isRawApiErrorPayload as k, extractToolResultId as l, sanitizeGoogleTurnOrdering as lt, classifyFailoverReason as m, validateGeminiTurns as n, resolveToolProfilePolicy as nt, normalizeTextForComparison as o, ensureSessionHeader as ot, BILLING_ERROR_USER_MESSAGE as p, resolveSandboxConfigForAgent as q, pickFallbackThinkingLevel as r, compileGlobPatterns as rt, sanitizeSessionMessagesImages as s, resolveBootstrapMaxChars as st, validateAnthropicTurns as t, normalizeToolName as tt, sanitizeToolCallIdsForCloudCodeAssist as u, getApiErrorPayloadFingerprint as v, isContextOverflowError as w, isBillingAssistantError as x, isAuthAssistantError as y, registerBrowserRoutes as z };