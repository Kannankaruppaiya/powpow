...
import { et as resolvePreferredPowPowTmpDir } from "./utils-C9Yd70Dr.js";
import { i as loadConfig } from "./config-ClR1jZcN.js";
import { _ as maxBytesForKind, l as extensionForMime } from "./image-ops-DDebYeLI.js";
import { C as resolveDiscordAccount, w as normalizeDiscordToken } from "./plugins-rCyIPzMG.js";
import { a as requireTargetKind, i as parseTargetPrefixes, n as ensureTargetId, r as parseTargetMention, t as buildMessagingTarget } from "./targets-Bp4SNTNz.js";
import { t as resolveFetch } from "./fetch-D3h8BpE_.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry--8gFlsEJ.js";
import { c as resolveChunkMode, i as chunkMarkdownTextWithMode } from "./chunk-DEySYRr3.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-iuOnj7Cl.js";
import { a as loadWebMedia, o as loadWebMediaRaw } from "./ir-BIBAnr1T.js";
import { n as normalizePollInput, t as normalizePollDurationHours } from "./polls-PiwufXwX.js";
import { n as recordChannelActivity, r as createDiscordRetryRunner } from "./channel-activity-DFMOrq2l.js";
...
async function generateWaveformFromPcm(filePath) {
	const tempDir = resolvePreferredPowPowTmpDir();
...
//#endregion
export { parseDiscordTarget as $, unpinMessageDiscord as A, listScheduledEventsDiscord as B, editMessageDiscord as C, resolveTimestampMs as Ct, pinMessageDiscord as D, normalizeChannelSlug as Dt, listThreadsDiscord as E, buildChannelKeyCandidates as Et, fetchMemberInfoDiscord as F, uploadStickerDiscord as G, timeoutMemberDiscord as H, fetchRoleInfoDiscord as I, editChannelDiscord as J, createChannelDiscord as K, fetchVoiceStatusDiscord as L, banMemberDiscord as M, createScheduledEventDiscord as N, readMessagesDiscord as O, resolveChannelEntryMatchWithFallback as Ot, fetchChannelInfoDiscord as P, stripUndefinedFields as Q, kickMemberDiscord as R, deleteMessageDiscord as S, resolveDiscordSystemLocation as St, listPinsDiscord as T, applyChannelMatchMeta as Tt, listGuildEmojisDiscord as U, removeRoleDiscord as V, uploadEmojiDiscord as W, removeChannelPermissionDiscord as X, moveChannelDiscord as Y, setChannelPermissionDiscord as Z, sendPollDiscord as _, resolveDiscordShouldRequireMention as _t, removeReactionDiscord as a, createDiscordClient as at, sendWebhookMessageDiscord as b, formatDiscordReactionEmoji as bt, formatDiscordComponentEventText as c, allowListMatches as ct, parseDiscordModalCustomId as d, normalizeDiscordSlug as dt, resolveDiscordChannelId as et, parseDiscordModalCustomIdForCarbon as f, resolveDiscordAllowListMatch as ft, sendMessageDiscord as g, resolveDiscordOwnerAllowFrom as gt, resolveDiscordModalEntry as h, resolveDiscordMemberAccessState as ht, removeOwnReactionsDiscord as i, hasAnyGuildPermissionDiscord as it, addRoleDiscord as j, searchMessagesDiscord as k, parseDiscordComponentCustomId as l, isDiscordGroupAllowedByPolicy as lt, resolveDiscordComponentEntry as m, resolveDiscordGuildEntry as mt, fetchReactionsDiscord as n, listDiscordDirectoryPeersLive as nt, sendDiscordComponentMessage as o, createDiscordRestClient as ot, readDiscordComponentSpec as p, resolveDiscordChannelConfigWithFallback as pt, deleteChannelDiscord as q, reactMessageDiscord as r, fetchChannelPermissionsDiscord as rt, createDiscordFormModal as s, chunkDiscordTextWithMode as st, send_exports as t, listDiscordDirectoryGroupsLive as tt, parseDiscordComponentCustomIdForCarbon as u, normalizeDiscordAllowList as ut, sendStickerDiscord as v, resolveGroupDmAllow as vt, fetchMessageDiscord as w, fetchDiscord as wt, createThreadDiscord as x, formatDiscordUserTag as xt, sendVoiceMessageDiscord as y, shouldEmitDiscordReactionNotification as yt, listGuildChannelsDiscord as z };