...
const GOOGLE_LIVE_SINGLE_KEY = "POWPOW_LIVE_GEMINI_KEY";
...
const PROVIDER_API_KEY_CONFIG = {
	anthropic: {
		liveSingle: "POWPOW_LIVE_ANTHROPIC_KEY",
		listVar: "POWPOW_LIVE_ANTHROPIC_KEYS",
	...
	openai: {
		liveSingle: "POWPOW_LIVE_OPENAI_KEY",
...
function resolveProviderApiKeyConfig(provider) {
	...
	const liveSingle = custom?.liveSingle ?? `POWPOW_LIVE_${base}_KEY`;
