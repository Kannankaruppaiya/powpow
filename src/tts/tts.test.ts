...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.POWPOW_TTS_PREFS;
      process.env.POWPOW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.POWPOW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: PowPowConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
