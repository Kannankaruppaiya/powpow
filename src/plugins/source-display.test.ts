...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/PowPow/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/PowPow/extensions",
        global: "/Users/x/.PowPow/extensions",
        workspace: "/Users/x/ws/.PowPow/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.PowPow/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/PowPow/extensions",
        global: "/Users/x/.PowPow/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.PowPow/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/PowPow/extensions",
        global: "/Users/x/.PowPow/extensions",
