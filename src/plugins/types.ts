...
export type PowPowPluginConfigSchema = {
...
export type PowPowPluginToolContext = {
  config?: PowPowConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type PowPowPluginToolFactory = (
  ctx: PowPowPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type PowPowPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type PowPowPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<PowPowConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type PowPowPluginGatewayMethod = {
  method: string;
 ...
 */
export type PowPowPluginCommandDefinition = {
...
export type PowPowPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type PowPowPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type PowPowPluginCliContext = {
  program: Command;
  config: PowPowConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type PowPowPluginCliRegistrar = (ctx: PowPowPluginCliContext) => void | Promise<void>;

export type PowPowPluginServiceContext = {
  config: PowPowConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type PowPowPluginService = {
  id: string;
  start: (ctx: PowPowPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: PowPowPluginServiceContext) => void | Promise<void>;
};

export type PowPowPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type PowPowPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: PowPowPluginConfigSchema;
  register?: (api: PowPowPluginApi) => void | Promise<void>;
  activate?: (api: PowPowPluginApi) => void | Promise<void>;
};

export type PowPowPluginModule =
  | PowPowPluginDefinition
  | ((api: PowPowPluginApi) => void | Promise<void>);

export type PowPowPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | PowPowPluginToolFactory,
    opts?: PowPowPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: PowPowPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: PowPowPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: PowPowPluginHttpRouteHandler }) => void;
  registerChannel: (registration: PowPowPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: PowPowPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: PowPowPluginService) => void;
   ...
   */
  registerCommand: (command: PowPowPluginCommandDefinition) => void;
