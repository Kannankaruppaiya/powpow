...
const loadPowPowPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadPowPowPlugins: (params: unknown) => loadPowPowPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadPowPowPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadPowPowPluginsMock.mockClear();
  });
