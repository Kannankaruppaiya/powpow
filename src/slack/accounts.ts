...
function mergeSlackAccountConfig(cfg: PowPowConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: PowPowConfig): ResolvedSlackAccount[] {
