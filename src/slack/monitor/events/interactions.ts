...
// Prefix for powpow-generated action IDs to scope our handler
const POWPOW_ACTION_PREFIX = "PowPow:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${POWPOW_ACTION_PREFIX}`);

  // Handle PowPow modal submissions with callback_ids scoped by our prefix.
