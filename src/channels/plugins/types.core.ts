...
export type ChannelAgentToolFactory = (params: { cfg?: PowPowConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: PowPowConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: PowPowConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: PowPowConfig }) => boolean;
  supportsCards?: (params: { cfg: PowPowConfig }) => boolean;
