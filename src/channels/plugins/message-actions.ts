...
export function listChannelMessageActions(cfg: PowPowConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: PowPowConfig): boolean {
...
export function supportsChannelMessageCards(cfg: PowPowConfig): boolean {
