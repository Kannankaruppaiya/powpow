...
import { discoverPowPowPlugins } from "../../plugins/discovery.js";
import type { PowPowPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, PowPowPackageManifest>>;
...
function toChannelMeta(params: {
  channel: NonNullable<PowPowPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: PowPowPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: PowPowPackageManifest;
