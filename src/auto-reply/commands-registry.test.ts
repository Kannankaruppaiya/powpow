...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@PowPow", { botUsername: "PowPow" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@PowPow args", {
        botUsername: "PowPow",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "PowPow" })).toBe(
      "/help@otherbot",
    );
  });
