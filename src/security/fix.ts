...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof PowPowConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: PowPowConfig; env: NodeJS.ProcessEnv }): {
  cfg: PowPowConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
