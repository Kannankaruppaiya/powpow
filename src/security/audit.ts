...
function collectLoggingFindings(cfg: PowPowConfig): SecurityAuditFinding[] {
...
function collectElevatedFindings(cfg: PowPowConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
...
function collectExecRuntimeFindings(cfg: PowPowConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
