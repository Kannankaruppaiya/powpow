...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated PowPow relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedPowPowRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-powpow-relay-token",
