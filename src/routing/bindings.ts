...
export function listBindings(cfg: PowPowConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: PowPowConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: PowPowConfig) {
