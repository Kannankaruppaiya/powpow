...
function getDiagnosticEventsState(): DiagnosticEventsGlobalState {
  const globalStore = globalThis as typeof globalThis & {
    __PowPowDiagnosticEventsState?: DiagnosticEventsGlobalState;
  };
  if (!globalStore.__PowPowDiagnosticEventsState) {
    globalStore.__PowPowDiagnosticEventsState = {
      seq: 0,
...
export function isDiagnosticsEnabled(config?: PowPowConfig): boolean {
