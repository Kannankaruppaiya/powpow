...
const defaultTools = createPowPowCodingTools({ senderIsOwner: true });
...
describe("createPowPowCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: PowPowConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createPowPowCodingTools({
    ...
    const anthropicTools = createPowPowCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: PowPowConfig = {
      tools: {
        exec: {
    ...
    const allowed = createPowPowCodingTools({
    ...
    const denied = createPowPowCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createPowPowCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
