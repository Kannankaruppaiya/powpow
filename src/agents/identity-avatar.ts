...
function resolveAvatarSource(cfg: PowPowConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: PowPowConfig, agentId: string): AgentAvatarResolution {
