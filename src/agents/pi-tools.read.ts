...
function resolveAdaptiveReadMaxBytes(options?: PowPowReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createPowPowReadTool(base, {
...
export function createPowPowReadTool(
  base: AnyAgentTool,
  options?: PowPowReadToolOptions,
): AnyAgentTool {
