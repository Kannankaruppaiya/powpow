...
async function resolveContext(config: PowPowConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): PowPowConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
