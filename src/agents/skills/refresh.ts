...
function resolveWatchPaths(workspaceDir: string, config?: PowPowConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: PowPowConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: PowPowConfig }) {
