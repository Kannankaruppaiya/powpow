...
export const DEFAULT_SANDBOX_IMAGE = "powpow-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "powpow-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "powpow-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "powpow-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "powpow-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "powpow-sandbox-browser";
