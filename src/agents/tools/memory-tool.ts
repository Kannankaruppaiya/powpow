...
function resolveMemoryToolContext(options: { config?: PowPowConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: PowPowConfig): MemoryCitationsMode {
