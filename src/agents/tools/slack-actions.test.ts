...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): PowPowConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: PowPowConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: PowPowConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
