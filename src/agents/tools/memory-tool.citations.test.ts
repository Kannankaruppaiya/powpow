...
function asPowPowConfig(config: Partial<PowPowConfig>): PowPowConfig {
  return config as PowPowConfig;
}

function createToolConfig() {
  return asPowPowConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: PowPowConfig = createToolConfig()) {
