...
function resolveAnthropicDefaultAuthMode(cfg: PowPowConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: PowPowConfig): PowPowConfig {
...
export function applyTalkApiKey(config: PowPowConfig): PowPowConfig {
...
export function applyTalkConfigNormalization(config: PowPowConfig): PowPowConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: PowPowConfig): PowPowConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: PowPowConfig): PowPowConfig {
...
export function applyLoggingDefaults(cfg: PowPowConfig): PowPowConfig {
...
export function applyContextPruningDefaults(cfg: PowPowConfig): PowPowConfig {
...
export function applyCompactionDefaults(cfg: PowPowConfig): PowPowConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
