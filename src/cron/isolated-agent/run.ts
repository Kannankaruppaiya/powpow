...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/PowPow/PowPow/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  // correct per-agent paths (e.g. ~/.PowPow/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: PowPowConfig = {
    ...params.cfg,
