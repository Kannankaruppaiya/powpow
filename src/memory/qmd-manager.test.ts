...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: PowPowConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: PowPowConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__PowPowMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__PowPowMcporterColdStartWarned;
  });
