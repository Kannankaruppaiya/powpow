...
function mergeDiscordAccountConfig(cfg: PowPowConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: PowPowConfig): ResolvedDiscordAccount[] {
