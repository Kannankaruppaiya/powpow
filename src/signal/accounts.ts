...
function mergeSignalAccountConfig(cfg: PowPowConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: PowPowConfig): ResolvedSignalAccount[] {
