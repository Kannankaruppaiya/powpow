...
function resolveDefaultAccountId(cfg: PowPowConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: PowPowConfig): boolean {
...
export function summarizeBindings(cfg: PowPowConfig, bindings: AgentBinding[]): string[] {
