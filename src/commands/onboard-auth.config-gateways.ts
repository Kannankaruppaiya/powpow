...
export function applyVercelAiGatewayProviderConfig(cfg: PowPowConfig): PowPowConfig {
...
export function applyVercelAiGatewayConfig(cfg: PowPowConfig): PowPowConfig {
