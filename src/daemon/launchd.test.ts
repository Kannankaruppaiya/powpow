...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.PowPow.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", POWPOW_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.PowPow.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when POWPOW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.PowPow.gateway.plist",
    },
    {
      name: "uses profile-specific label when POWPOW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", POWPOW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.PowPow.jbphoenix.plist",
    },
    {
      name: "prefers POWPOW_LAUNCHD_LABEL over POWPOW_PROFILE",
      env: {
        HOME: "/Users/test",
        POWPOW_PROFILE: "jbphoenix",
        POWPOW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from POWPOW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        POWPOW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty POWPOW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        POWPOW_PROFILE: "myprofile",
        POWPOW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.PowPow.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
