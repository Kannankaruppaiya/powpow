...
${formatHelpExamples([
  ...
  [
    'PowPow agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'PowPow agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['PowPow agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'PowPow agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
    "Send reply to a different channel/target.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.PowPow.ai/cli/agent")}`,
    )
    .action(async (opts) => {
...
${formatHelpExamples([
  ...
  [
    "PowPow agents set-identity --workspace ~/.PowPow/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "PowPow agents set-identity --identity-file ~/.PowPow/workspace/IDENTITY.md --agent main",
