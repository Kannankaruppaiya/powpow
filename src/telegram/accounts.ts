...
function listConfiguredAccountIds(cfg: PowPowConfig): string[] {
...
export function listTelegramAccountIds(cfg: PowPowConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: PowPowConfig): string {
...
function mergeTelegramAccountConfig(cfg: PowPowConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: PowPowConfig): ResolvedTelegramAccount[] {
