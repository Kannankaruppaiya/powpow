...
export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "POWPOW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "POWPOW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "POWPOW_TELEGRAM_DNS_RESULT_ORDER";
