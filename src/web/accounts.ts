...
export function listWhatsAppAuthDirs(cfg: PowPowConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: PowPowConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: PowPowConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: PowPowConfig): ResolvedWhatsAppAccount[] {
