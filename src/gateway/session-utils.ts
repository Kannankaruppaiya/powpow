...
import { type PowPowConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: PowPowConfig): string[] {
...
export function listAgentsForGateway(cfg: PowPowConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: PowPowConfig): string {
...
function resolveSessionStoreAgentId(cfg: PowPowConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: PowPowConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: PowPowConfig): GatewaySessionsDefaults {
