...
const ENTRY_WRAPPER_PAIRS = [
  { wrapperBasename: "PowPow.mjs", entryBasename: "entry.js" },
  { wrapperBasename: "PowPow.js", entryBasename: "entry.js" },
] as const;
...
if (
  ...
  function ensureExperimentalWarningSuppressed(): boolean {
    ...
    if (isTruthyEnvValue(process.env.POWPOW_NO_RESPAWN)) {
      return false;
    }
    if (isTruthyEnvValue(process.env.POWPOW_NODE_OPTIONS_READY)) {
      return false;
    }
    ...
    process.env.POWPOW_NODE_OPTIONS_READY = "1";
